                    ...
                    else if (ksize == 5)
                    {
                        if (border_type == BORDER_REPLICATE)
                        {
                            ...
                            for (size_t y = 0; y < height; y++)
                            {
                                ...
                                if (dy == 0)
                                {
                                    nextxp1 = srowm2[2] + 4 * srowm1[2] + 6 * srow0[2] + 4 * srowp1[2] + srowp2[2];
                                    nextxp2 = srowm2[3] + 4 * srowm1[3] + 6 * srow0[3] + 4 * srowp1[3] + srowp2[3];
                                }
                                else if (dy == 1)
                                {
                                    nextxp1 = -1 * srowm2[2] - 2 * srowm1[2] + 0 * srow0[2] + 2 * srowp1[2] + srowp2[2];
                                    nextxp2 = -1 * srowm2[3] - 2 * srowm1[3] + 0 * srow0[3] + 2 * srowp1[3] + srowp2[3];
                                }
                                else
                                {
                                    nextxp1 = srowm2[2] + 0 * srowm1[2] - 2 * srow0[2] + 0 * srowp1[2] + srowp2[2];
                                ...
                                x = 2;
                                size_t vl = __riscv_vsetvl_e8m4(width - x);
                                vint16m8_t vsrowm2, vsrowm1, vsrow0, vsrowp1, vsrowp2;
                                vint16m8_t vprevxm2, vprevxm1, vrowx, vnextxp1, vnextxp2;
                                vprevxm2 = __riscv_vmv_v_x_i16m8(prevxm2, vl);
                                vprevxm1 = __riscv_vmv_v_x_i16m8(prevxm1, vl);
                                vrowx = __riscv_vmv_v_x_i16m8(rowx, vl);
                                vnextxp1 = __riscv_vmv_v_x_i16m8(nextxp1, vl);
                                for (; x < width - 2; x += vl)
                                {
                                    vl = __riscv_vsetvl_e8m4(width - 2 - x);
                                    vsrowm2 = __riscv_vreinterpret_v_u16m8_i16m8(__riscv_vwcvtu_x_x_v_u16m8(__riscv_vle8_v_u8m4(srowm2 + x + 2, vl), vl));
                                    vsrowm1 = __riscv_vreinterpret_v_u16m8_i16m8(__riscv_vwcvtu_x_x_v_u16m8(__riscv_vle8_v_u8m4(srowm1 + x + 2, vl), vl));
                                    vsrow0 = __riscv_vreinterpret_v_u16m8_i16m8(__riscv_vwcvtu_x_x_v_u16m8(__riscv_vle8_v_u8m4(srow0 + x + 2, vl), vl));
                                    vsrowp1 = __riscv_vreinterpret_v_u16m8_i16m8(__riscv_vwcvtu_x_x_v_u16m8(__riscv_vle8_v_u8m4(srowp1 + x + 2, vl), vl));
                                    vsrowp2 = __riscv_vreinterpret_v_u16m8_i16m8(__riscv_vwcvtu_x_x_v_u16m8(__riscv_vle8_v_u8m4(srowp2 + x + 2, vl), vl));
                                    if (dy == 0)
                                    {
                                        vnextxp2 = __riscv_vadd_vv_i16m8(vsrowm2, vsrowp2, vl);
                                        vnextxp2 = __riscv_vmacc_vx_i16m8(vnextxp2, 4, vsrowm1, vl);
                                        vnextxp2 = __riscv_vmacc_vx_i16m8(vnextxp2, 6, vsrow0, vl);
                                        vnextxp2 = __riscv_vmacc_vx_i16m8(vnextxp2, 4, vsrowp1, vl);

                                        vnextxp1 = __riscv_vslideup_vx_i16m8(vnextxp1, vnextxp2, 1, vl);
                                        vrowx = __riscv_vslideup_vx_i16m8(vrowx, vnextxp1, 1, vl);
                                        vprevxm1 = __riscv_vslideup_vx_i16m8(vprevxm1, vrowx, 1, vl);
                                        vprevxm2 = __riscv_vslideup_vx_i16m8(vprevxm2, vprevxm1, 1, vl);
                                    }
                                    else if (dy == 1)
                                    {
                                        vnextxp2 = __riscv_vsub_vv_i16m8(vsrowp2, vsrowm2, vl);
                                        vnextxp2 = __riscv_vmacc_vx_i16m8(vnextxp2, -2, vsrowm1, vl);
                                        vnextxp2 = __riscv_vmacc_vx_i16m8(vnextxp2, 2, vsrowp1, vl);
                                    ...
                                    {
                                        vnextxp2 = __riscv_vadd_vv_i16m8(vsrowm2, vsrowp2, vl);
                                        vnextxp2 = __riscv_vmacc_vx_i16m8(vnextxp2, -2, vsrow0, vl);
                                    ...
                                    vprevxm2 = __riscv_vslidedown_vx_i16m8(vprevxm2, vl - 1, vl);
                                    vprevxm1 = __riscv_vslidedown_vx_i16m8(vprevxm1, vl - 1, vl);
                                    vrowx = __riscv_vslidedown_vx_i16m8(vrowx, vl - 1, vl);
                                    vnextxp1 = __riscv_vslidedown_vx_i16m8(vnextxp1, vl - 1, vl);

                                    if (y % 3 == 0)
                                    {
                                        __riscv_vse8_v_u8m4(trow0 + x, vres, vl);
                                    }
                                    else if (y % 3 == 1)
                                    {
                                        __riscv_vse8_v_u8m4(trow1 + x, vres, vl);
                                    }
                                    else
                                    {
                                        __riscv_vse8_v_u8m4(trow2 + x, vres, vl);
                                    }
                                }
                                ...
                                if (y >= 2)
                                {
                                    ...
                                    for (size_t x1 = 0; x1 < width; x1 += vl)
                                    {
                                        ...
                                        __riscv_vse8_v_u8m8(drow_target + x1, vdata, vl);
                                    }
                                }
                            }
                            ...
                            for (int remaining_y = (height >= 2 ? height - 2 : 0); remaining_y < height; remaining_y++)
                            {
                                ...
                                for (size_t x1 = 0; x1 < width; x1 += vl)
                                {
                                    ...
                                    __riscv_vse8_v_u8m8(drow_current + x1, vdata, vl);
                                }
                            }
                ...
                else if (dst_depth == CV_16S)
                {
                    ...
                    else if (ksize == 5)
                    {
                        if (border_type == BORDER_REPLICATE)
                        {
                            ...
                            for (size_t y = 0; y < height; y++)
                            {
                                ...
                                for (; x < width - 2; x += vl)
                                {
                                    ...
                                    if (y % 3 == 0)
                                    {
                                        __riscv_vse16_v_i16m8(trow0 + x, grad, vl);
                                    }
                                    else if (y % 3 == 1)
                                    {
                                        __riscv_vse16_v_i16m8(trow1 + x, grad, vl);
                                    }
                                    else
                                    {
                                        __riscv_vse16_v_i16m8(trow2 + x, grad, vl);
                                    }
                                }
                                ...
                                if (y >= 2)
                                {
                                    ...
                                    for (size_t x1 = 0; x1 < width; x1 += vl)
                                    {
                                        ...
                                        __riscv_vse16_v_i16m8(drow_target + x1, vdata, vl);
                                    }
                                }
                            }
                            ...
                            for (int remaining_y = (height >= 2 ? height - 2 : 0); remaining_y < height; remaining_y++)
                            {
                                ...
                                for (size_t x1 = 0; x1 < width; x1 += vl)
                                {
                                    ...
                                    __riscv_vse16_v_i16m8(drow_current + x1, vdata, vl);
                                }
                            }
                        ...
                        else if (border_type == BORDER_CONSTANT)
                        {
                            int align_size = (width + 4 + 7) & -8;
                            constexpr size_t alignment = 64;
                            size_t bufferSize = (align_size * 3 * sizeof(int16_t)) + alignment;
                    ...
                    else if (ksize == 5)
                    {
                        if (border_type == BORDER_REPLICATE)
                        {
                            ...
                            for (size_t y = 0; y < height; y++)
                            {
                                ...
                                x = 2;
                                size_t vl = __riscv_vsetvl_e8m2(width - x);
                                vfloat32m8_t vsrowm2, vsrowm1, vsrow0, vsrowp1, vsrowp2;
                                vfloat32m8_t vprevxm2, vprevxm1, vrowx, vnextxp1, vnextxp2;
                                vprevxm2 = __riscv_vfmv_v_f_f32m8(prevxm2, vl);
                                vprevxm1 = __riscv_vfmv_v_f_f32m8(prevxm1, vl);
                                vrowx = __riscv_vfmv_v_f_f32m8(rowx, vl);
                                vnextxp1 = __riscv_vfmv_v_f_f32m8(nextxp1, vl);
                                for (; x < width - 2; x += vl)
                                {
                                    vl = __riscv_vsetvl_e8m2(width - 2 - x);
                                    vsrowm2 = __riscv_vfwcvt_f_xu_v_f32m8(__riscv_vwcvtu_x_x_v_u16m4(__riscv_vle8_v_u8m2(srowm2 + x + 2, vl), vl), vl);
                                    vsrowm1 = __riscv_vfwcvt_f_xu_v_f32m8(__riscv_vwcvtu_x_x_v_u16m4(__riscv_vle8_v_u8m2(srowm1 + x + 2, vl), vl), vl);
                                    vsrow0 = __riscv_vfwcvt_f_xu_v_f32m8(__riscv_vwcvtu_x_x_v_u16m4(__riscv_vle8_v_u8m2(srow0 + x + 2, vl), vl), vl);
                                    vsrowp1 = __riscv_vfwcvt_f_xu_v_f32m8(__riscv_vwcvtu_x_x_v_u16m4(__riscv_vle8_v_u8m2(srowp1 + x + 2, vl), vl), vl);
                                    vsrowp2 = __riscv_vfwcvt_f_xu_v_f32m8(__riscv_vwcvtu_x_x_v_u16m4(__riscv_vle8_v_u8m2(srowp2 + x + 2, vl), vl), vl);
                                    if (dy == 0)
                                    {
                                        vnextxp2 = __riscv_vfadd_vv_f32m8(vsrowm2, vsrowp2, vl);
                                        vnextxp2 = __riscv_vfmacc_vf_f32m8(vnextxp2, 4, vsrowm1, vl);
                                        vnextxp2 = __riscv_vfmacc_vf_f32m8(vnextxp2, 6, vsrow0, vl);
                                        vnextxp2 = __riscv_vfmacc_vf_f32m8(vnextxp2, 4, vsrowp1, vl);

                                        vnextxp1 = __riscv_vslideup_vx_f32m8(vnextxp1, vnextxp2, 1, vl);
                                        vrowx = __riscv_vslideup_vx_f32m8(vrowx, vnextxp1, 1, vl);
                                        vprevxm1 = __riscv_vslideup_vx_f32m8(vprevxm1, vrowx, 1, vl);
                                        vprevxm2 = __riscv_vslideup_vx_f32m8(vprevxm2, vprevxm1, 1, vl);
                                    }
                                    else if (dy == 1)
                                    {
                                        vnextxp2 = __riscv_vfsub_vv_f32m8(vsrowp2, vsrowm2, vl);
                                        vnextxp2 = __riscv_vfmacc_vf_f32m8(vnextxp2, -2, vsrowm1, vl);
                                        vnextxp2 = __riscv_vfmacc_vf_f32m8(vnextxp2, 2, vsrowp1, vl);
                                    ...
                                    {
                                        vnextxp2 = __riscv_vfadd_vv_f32m8(vsrowm2, vsrowp2, vl);
                                        vnextxp2 = __riscv_vfmacc_vf_f32m8(vnextxp2, -2, vsrow0, vl);
                                    ...
                                    vprevxm2 = __riscv_vslidedown_vx_f32m8(vprevxm2, vl - 1, vl);
                                    vprevxm1 = __riscv_vslidedown_vx_f32m8(vprevxm1, vl - 1, vl);
                                    vrowx = __riscv_vslidedown_vx_f32m8(vrowx, vl - 1, vl);
                                    vnextxp1 = __riscv_vslidedown_vx_f32m8(vnextxp1, vl - 1, vl);

                                    if (y % 3 == 0)
                                    {
                                        __riscv_vse32_v_f32m8(trow0 + x, grad, vl);
                                    }
                                    else if (y % 3 == 1)
                                    {
                                        __riscv_vse32_v_f32m8(trow1 + x, grad, vl);
                                    }
                                    else
                                    {
                                        __riscv_vse32_v_f32m8(trow2 + x, grad, vl);
                                    }
                                }
                                ...
                                if (y >= 2)
                                {
                                    ...
                                    for (size_t x1 = 0; x1 < width; x1 += vl)
                                    {
                                        ...
                                        __riscv_vse32_v_f32m8(drow_target + x1, vdata, vl);
                                    }
                                }
                            }
                            ...
                            for (int remaining_y = (height >= 2 ? height - 2 : 0); remaining_y < height; remaining_y++)
                            {
                                ...
                                for (size_t x1 = 0; x1 < width; x1 += vl)
                                {
                                    ...
                                    __riscv_vse32_v_f32m8(drow_current + x1, vdata, vl);
                                }
                            }
                        ...
                        else if (border_type == BORDER_CONSTANT)
                        {
                            int align_size = (width + 4 + 7) & -8;
                            constexpr size_t alignment = 64;
                            size_t bufferSize = (align_size * 3 * sizeof(float)) + alignment;
                            float *_tempBuf = static_cast<float *>(aligned_alloc(alignment, bufferSize));
