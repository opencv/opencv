...
1.  Sampling method:
    ...
    1.  Uniform – standard RANSAC sampling proposed in [\[FischlerRANSAC\]](https://docs.opencv.org/5.x/d0/de3/citelist.html#CITEREF_FischlerRANSAC) which draw
        minimal subset independently uniformly at random. *The default
        option in proposed framework*.

    2.  PROSAC – method [\[ChumPROSAC\]](https://docs.opencv.org/5.x/d0/de3/citelist.html#CITEREF_ChumPROSAC) that assumes input data points sorted by
    ...
    3.  NAPSAC – sampling method [\[MyattNAPSAC\]](https://docs.opencv.org/5.x/d0/de3/citelist.html#CITEREF_MyattNAPSAC) which takes initial point
    ...
    4.  Progressive-NAPSAC – sampler [\[barath2019progressive\]](https://docs.opencv.org/5.x/d0/de3/citelist.html#CITEREF_barath2019progressive) which is similar to NAPSAC,
...
2.  Score Method. USAC as well as standard RANSAC finds model which
    ...
    3.  MAGSAC – threshold-free method [\[BarathMAGSAC\]](https://docs.opencv.org/5.x/d0/de3/citelist.html#CITEREF_BarathMAGSAC) to compute score. Using,
...
4.  Degeneracy:
    ...
    1.  DEGENSAC – method [\[ChumDominant\]](https://docs.opencv.org/5.x/d0/de3/citelist.html#CITEREF_ChumDominant) which for Fundamental matrix estimation
    ...
    3.  Oriented epipolar constraint – method [\[ChumEpipolar\]](https://docs.opencv.org/5.x/d0/de3/citelist.html#CITEREF_ChumEpipolar) for epipolar
        geometry which verifies model (fundamental and essential matrix)
        to have points visible in the front of the camera.

5.  SPRT verification – method [\[Matas2005RandomizedRW\]](https://docs.opencv.org/5.x/d0/de3/citelist.html#CITEREF_Matas2005RandomizedRW) which verifies model by its
...
6.  Local Optimization:
    ...
    1.  Locally Optimized RANSAC – method [\[ChumLORANSAC\]](https://docs.opencv.org/5.x/d0/de3/citelist.html#CITEREF_ChumLORANSAC) that iteratively
    ...
    2.  Graph-Cut RANSAC – method [\[BarathGCRANSAC\]](https://docs.opencv.org/5.x/d0/de3/citelist.html#CITEREF_BarathGCRANSAC) that refine so-far-the-best
        model, however, it exploits spatial coherence of the
        data points. *This procedure is quite precise however
        computationally slower.*

    3.  Sigma Consensus – method [\[BarathMAGSAC\]](https://docs.opencv.org/5.x/d0/de3/citelist.html#CITEREF_BarathMAGSAC) which improves model by applying
...
8.  Solver. In the framework there are minimal and non-minimal solvers.
    ...
    4.  Essential matrix – 4 null vectors are found using
        ...
        described in [\[SteweniusRecent\]](https://docs.opencv.org/5.x/d0/de3/citelist.html#CITEREF_SteweniusRecent) is used. Essential matrix can be computed
...
3.  `NEIGH_GRID` – for finding points’ neighborhood tiles points in
    cells using hash-table. The method is described in [\[barath2019progressive\]](https://docs.opencv.org/5.x/d0/de3/citelist.html#CITEREF_barath2019progressive). Less
