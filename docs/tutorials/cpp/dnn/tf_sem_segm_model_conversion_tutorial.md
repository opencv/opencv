(tf_segm_tutorial_dnn_conversion)=
...
```{figure} images/2007_000033.png
:alt: PASCAL VOC ground truth
...
```{figure} images/colors_legend.png
:alt: Color Legend

Color Legend
```

```{figure} images/deeplab_opencv_colored_mask.png
:alt: OpenCV Colored Mask
...
```{figure} images/deeplab_tf_colored_mask.png
:alt: TF Colored Mask
