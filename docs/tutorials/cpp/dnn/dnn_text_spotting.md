...
In the current version, [cv::dnn::TextRecognitionModel](https://docs.opencv.org/5.x/de/dee/classcv_1_1dnn_1_1TextRecognitionModel.html) only supports CNN+RNN+CTC based algorithms,
...
[cv::dnn::TextRecognitionModel::recognize](https://docs.opencv.org/5.x/de/dee/classcv_1_1dnn_1_1TextRecognitionModel.html#ad8bfaa53724392dc9477fb55168a0340)() is the main function for text recognition.
...
[cv::dnn::TextDetectionModel](https://docs.opencv.org/5.x/d4/de1/classcv_1_1dnn_1_1TextDetectionModel.html) API provides these methods for text detection:
- [cv::dnn::TextDetectionModel::detect](https://docs.opencv.org/5.x/d4/de1/classcv_1_1dnn_1_1TextDetectionModel.html#a4eff7e9334c93402bbd78e87fae427ca)() returns the results in std::vector<std::vector<Point>> (4-points quadrangles)
- [cv::dnn::TextDetectionModel::detectTextRectangles](https://docs.opencv.org/5.x/d4/de1/classcv_1_1dnn_1_1TextDetectionModel.html#a208e6deed83dd4554f6f932acfd795aa)() returns the results in std::vector<[cv::RotatedRect](https://docs.opencv.org/5.x/db/dd6/classcv_1_1RotatedRect.html)> (RBOX-like)

In the current version, [cv::dnn::TextDetectionModel](https://docs.opencv.org/5.x/d4/de1/classcv_1_1dnn_1_1TextDetectionModel.html) supports these algorithms:
- use [cv::dnn::TextDetectionModel_DB](https://docs.opencv.org/5.x/db/d0f/classcv_1_1dnn_1_1TextDetectionModel__DB.html) with "DB" models
- and use [cv::dnn::TextDetectionModel_EAST](https://docs.opencv.org/5.x/d8/ddc/classcv_1_1dnn_1_1TextDetectionModel__EAST.html) with "EAST" models
...
```{figure} images/text_rec_test.png
:alt: Picture example
...
```{figure} images/text_det_test_results.jpg
:alt: Picture example
...
```{figure} images/detect_test1.jpg
:alt: Picture example

Picture example
```

```{figure} images/detect_test2.jpg
:alt: Picture example
