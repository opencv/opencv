...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("drawChessboardCorners");
  parser.addVariant("drawChessboardCorners", 4, 0);
  ...
  Mat corners = inputs[2].toMat();
  bool patternWasFound = inputs[3].toBool();
  ...
  try {
    ...
    error("Uncaught exception occurred in drawChessboardCorners");
  }
