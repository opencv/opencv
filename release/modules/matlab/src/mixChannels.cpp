...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("mixChannels");
  parser.addVariant("mixChannels", 3, 0);
  ...
  vector_int fromTo = inputs[2].toVectorInt();
  ...
  try {
    ...
    error("Uncaught exception occurred in mixChannels");
  }
