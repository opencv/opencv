...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("correctMatches");
  parser.addVariant("correctMatches", 3, 0);
  ...
  try {
    ...
    error("Uncaught exception occurred in correctMatches");
  }
  
  // assign the outputs into the bridge
  outputs[0] = newPoints1;
  outputs[1] = newPoints2;
