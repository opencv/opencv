...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("inpaint");
  parser.addVariant("inpaint", 4, 0);
  ...
  Mat inpaintMask = inputs[1].toMat();
  double inpaintRadius = inputs[2].toDouble();
  ...
  try {
    ...
    error("Uncaught exception occurred in inpaint");
  }
