...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("moments");
  parser.addVariant("moments", 1, 1, "binaryImage");
  ...
  Mat array = inputs[0].toMat();
  bool binaryImage = inputs[1].empty() ? (bool) false : inputs[1].toBool();
  Moments retval;
  ...
  try {
    ...
    error("Uncaught exception occurred in moments");
  }
