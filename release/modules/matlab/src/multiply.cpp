...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("multiply");
  parser.addVariant("multiply", 2, 2, "scale", "dtype");
  ...
  double scale = inputs[2].empty() ? (double) 1 : inputs[2].toDouble();
  int dtype = inputs[3].empty() ? (int) -1 : inputs[3].toInt();
  Mat dst;
  ...
  try {
    ...
    error("Uncaught exception occurred in multiply");
  }
