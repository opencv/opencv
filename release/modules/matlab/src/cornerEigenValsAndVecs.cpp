...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("cornerEigenValsAndVecs");
  parser.addVariant("cornerEigenValsAndVecs", 3, 1, "borderType");
  ...
  try {
    ...
    error("Uncaught exception occurred in cornerEigenValsAndVecs");
  }
