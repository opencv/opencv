...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("polarToCart");
  parser.addVariant("polarToCart", 2, 1, "angleInDegrees");
  ...
  Mat magnitude = inputs[0].toMat();
  Mat angle = inputs[1].toMat();
  ...
  try {
    ...
    error("Uncaught exception occurred in polarToCart");
  }
