...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("adaptiveThreshold");
  parser.addVariant("adaptiveThreshold", 6, 0);
  ...
  double maxValue = inputs[1].toDouble();
  int adaptiveMethod = inputs[2].toInt();
  int thresholdType = inputs[3].toInt();
  int blockSize = inputs[4].toInt();
  double C = inputs[5].toDouble();
  Mat dst;
  ...
  try {
    ...
    error("Uncaught exception occurred in adaptiveThreshold");
  }
