...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("createHanningWindow");
  parser.addVariant("createHanningWindow", 2, 0);
  ...
  try {
    ...
    error("Uncaught exception occurred in createHanningWindow");
  }
