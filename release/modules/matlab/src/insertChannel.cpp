...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("insertChannel");
  parser.addVariant("insertChannel", 3, 0);
  ...
  try {
    ...
    error("Uncaught exception occurred in insertChannel");
  }
