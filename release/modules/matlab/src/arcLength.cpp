...
/*
 * arcLength
 * double arcLength(Mat curve, bool closed);
 * Gateway routine
...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("arcLength");
  parser.addVariant("arcLength", 2, 0);
  ...
  try {
    ...
    error("Uncaught exception occurred in arcLength");
  }
