...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("contourArea");
  parser.addVariant("contourArea", 1, 1, "oriented");
  ...
  bool oriented = inputs[1].empty() ? (bool) false : inputs[1].toBool();
  double retval;
  ...
  try {
    ...
    error("Uncaught exception occurred in contourArea");
  }
