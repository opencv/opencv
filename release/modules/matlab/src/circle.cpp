...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("circle");
  parser.addVariant("circle", 4, 3, "thickness", "lineType", "shift");
  ...
  Point center = inputs[1].toPoint();
  int radius = inputs[2].toInt();
  ...
  try {
    ...
    error("Uncaught exception occurred in circle");
  }
