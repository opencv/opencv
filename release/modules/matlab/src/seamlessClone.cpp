...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("seamlessClone");
  parser.addVariant("seamlessClone", 5, 0);
  ...
  Point p = inputs[3].toPoint();
  int flags = inputs[4].toInt();
  Mat blend;
  ...
  try {
    ...
    error("Uncaught exception occurred in seamlessClone");
  }
