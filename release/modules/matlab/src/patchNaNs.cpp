...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("patchNaNs");
  parser.addVariant("patchNaNs", 1, 1, "val");
  ...
  double val = inputs[1].empty() ? (double) 0 : inputs[1].toDouble();
  ...
  try {
    ...
    error("Uncaught exception occurred in patchNaNs");
  }
