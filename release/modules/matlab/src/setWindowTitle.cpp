...
void mexFunction(int nlhs, mxArray**,
  ...
  // parse the inputs
  ArgumentParser parser("setWindowTitle");
  parser.addVariant("setWindowTitle", 2, 0);
  ...
  String title = inputs[1].toString();
  ...
  try {
    ...
    error("Uncaught exception occurred in setWindowTitle");
  }
