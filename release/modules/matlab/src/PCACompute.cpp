...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("PCACompute");
  parser.addVariant("PCACompute", 3, 0);
  ...
  double retainedVariance = inputs[2].toDouble();
  Mat eigenvectors;
  ...
  try {
    ...
    error("Uncaught exception occurred in PCACompute");
  }
  
  // assign the outputs into the bridge
  outputs[0] = mean;
  outputs[1] = eigenvectors;
