...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("pyrDown");
  parser.addVariant("pyrDown", 1, 2, "dstsize", "borderType");
  ...
  Size dstsize = inputs[1].empty() ? (Size) Size() : inputs[1].toSize();
  ...
  try {
    ...
    error("Uncaught exception occurred in pyrDown");
  }
