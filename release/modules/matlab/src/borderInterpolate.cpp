...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("borderInterpolate");
  parser.addVariant("borderInterpolate", 3, 0);
  ...
  int p = inputs[0].toInt();
  int len = inputs[1].toInt();
  int borderType = inputs[2].toInt();
  int retval;
  ...
  try {
    ...
    error("Uncaught exception occurred in borderInterpolate");
  }
