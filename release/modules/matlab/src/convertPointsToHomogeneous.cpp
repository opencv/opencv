...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("convertPointsToHomogeneous");
  parser.addVariant("convertPointsToHomogeneous", 1, 0);
  ...
  try {
    ...
    error("Uncaught exception occurred in convertPointsToHomogeneous");
  }
