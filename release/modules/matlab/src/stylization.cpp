...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("stylization");
  parser.addVariant("stylization", 1, 2, "sigma_s", "sigma_r");
  ...
  float sigma_r = inputs[2].empty() ? (float) 0.45f : inputs[2].toFloat();
  Mat dst;
  ...
  try {
    ...
    error("Uncaught exception occurred in stylization");
  }
