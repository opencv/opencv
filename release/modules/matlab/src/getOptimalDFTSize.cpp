...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("getOptimalDFTSize");
  parser.addVariant("getOptimalDFTSize", 1, 0);
  ...
  try {
    ...
    error("Uncaught exception occurred in getOptimalDFTSize");
  }
