...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("divide");
  parser.addVariant("divide", 2, 1, "dtype");
  ...
  double scale = inputs[0].toDouble();
  Mat src2 = inputs[1].toMat();
  int dtype = inputs[2].empty() ? (int) -1 : inputs[2].toInt();
  Mat dst;
  ...
  try {
    ...
    error("Uncaught exception occurred in divide");
  }
