...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("estimateRigidTransform");
  parser.addVariant("estimateRigidTransform", 3, 0);
  ...
  bool fullAffine = inputs[2].toBool();
  Mat retval;
  ...
  try {
    ...
    error("Uncaught exception occurred in estimateRigidTransform");
  }
