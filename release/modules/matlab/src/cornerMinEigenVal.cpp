...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("cornerMinEigenVal");
  parser.addVariant("cornerMinEigenVal", 2, 2, "ksize", "borderType");
  ...
  int ksize = inputs[2].empty() ? (int) 3 : inputs[2].toInt();
  ...
  try {
    ...
    error("Uncaught exception occurred in cornerMinEigenVal");
  }
