...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("convertScaleAbs");
  parser.addVariant("convertScaleAbs", 1, 2, "alpha", "beta");
  ...
  double alpha = inputs[1].empty() ? (double) 1 : inputs[1].toDouble();
  double beta = inputs[2].empty() ? (double) 0 : inputs[2].toDouble();
  Mat dst;
  ...
  try {
    ...
    error("Uncaught exception occurred in convertScaleAbs");
  }
