...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("imdecode");
  parser.addVariant("imdecode", 2, 0);
  ...
  Mat buf = inputs[0].toMat();
  int flags = inputs[1].toInt();
  Mat retval;
  ...
  try {
    ...
    error("Uncaught exception occurred in imdecode");
  }
