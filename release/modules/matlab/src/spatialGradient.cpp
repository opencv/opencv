...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("spatialGradient");
  parser.addVariant("spatialGradient", 1, 2, "ksize", "borderType");
  ...
  int ksize = inputs[1].empty() ? (int) 3 : inputs[1].toInt();
  int borderType = inputs[2].empty() ? (int) BORDER_DEFAULT : inputs[2].toInt();
  Mat dx;
  Mat dy;
  ...
  try {
    ...
    error("Uncaught exception occurred in spatialGradient");
  }
