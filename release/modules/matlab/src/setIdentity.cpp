...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("setIdentity");
  parser.addVariant("setIdentity", 1, 1, "s");
  ...
  Scalar s = inputs[1].empty() ? (Scalar) Scalar(1) : inputs[1].toScalar();
  ...
  try {
    ...
    error("Uncaught exception occurred in setIdentity");
  }
