...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("convertPointsFromHomogeneous");
  parser.addVariant("convertPointsFromHomogeneous", 1, 0);
  ...
  try {
    ...
    error("Uncaught exception occurred in convertPointsFromHomogeneous");
  }
