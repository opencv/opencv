...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("validateDisparity");
  parser.addVariant("validateDisparity", 4, 1, "disp12MaxDisp");
  ...
  Mat cost = inputs[1].toMat();
  int minDisparity = inputs[2].toInt();
  int numberOfDisparities = inputs[3].toInt();
  int disp12MaxDisp = inputs[4].empty() ? (int) 1 : inputs[4].toInt();
  ...
  try {
    ...
    error("Uncaught exception occurred in validateDisparity");
  }
