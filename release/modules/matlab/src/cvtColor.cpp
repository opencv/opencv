...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("cvtColor");
  parser.addVariant("cvtColor", 2, 1, "dstCn");
  ...
  int dstCn = inputs[2].empty() ? (int) 0 : inputs[2].toInt();
  Mat dst;
  ...
  try {
    ...
    error("Uncaught exception occurred in cvtColor");
  }
