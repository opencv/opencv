...
void mexFunction(int nlhs, mxArray**,
  ...
  // parse the inputs
  ArgumentParser parser("setTrackbarMax");
  parser.addVariant("setTrackbarMax", 3, 0);
  ...
  try {
    ...
    error("Uncaught exception occurred in setTrackbarMax");
  }
