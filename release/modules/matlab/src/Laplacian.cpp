...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("Laplacian");
  parser.addVariant("Laplacian", 2, 4, "ksize", "scale", "delta", "borderType");
  ...
  int ksize = inputs[2].empty() ? (int) 1 : inputs[2].toInt();
  ...
  try {
    ...
    error("Uncaught exception occurred in Laplacian");
  }
