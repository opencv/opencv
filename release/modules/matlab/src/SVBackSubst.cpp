...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("SVBackSubst");
  parser.addVariant("SVBackSubst", 4, 0);
  ...
  Mat w = inputs[0].toMat();
  Mat u = inputs[1].toMat();
  Mat vt = inputs[2].toMat();
  Mat rhs = inputs[3].toMat();
  Mat dst;
  ...
  try {
    ...
    error("Uncaught exception occurred in SVBackSubst");
  }
