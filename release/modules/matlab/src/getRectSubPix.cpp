...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("getRectSubPix");
  parser.addVariant("getRectSubPix", 3, 1, "patchType");
  ...
  Size patchSize = inputs[1].toSize();
  Point2f center = inputs[2].toPoint2f();
  int patchType = inputs[3].empty() ? (int) -1 : inputs[3].toInt();
  Mat patch;
  ...
  try {
    ...
    error("Uncaught exception occurred in getRectSubPix");
  }
