...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("compareHist");
  parser.addVariant("compareHist", 3, 0);
  ...
  Mat H1 = inputs[0].toMat();
  Mat H2 = inputs[1].toMat();
  ...
  try {
    ...
    error("Uncaught exception occurred in compareHist");
  }
