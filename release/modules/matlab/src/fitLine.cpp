...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("fitLine");
  parser.addVariant("fitLine", 5, 0);
  ...
  int distType = inputs[1].toInt();
  double param = inputs[2].toDouble();
  double reps = inputs[3].toDouble();
  double aeps = inputs[4].toDouble();
  Mat line;
  ...
  try {
    ...
    error("Uncaught exception occurred in fitLine");
  }
