...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("remap");
  parser.addVariant("remap", 4, 2, "borderMode", "borderValue");
  ...
  Mat map1 = inputs[1].toMat();
  Mat map2 = inputs[2].toMat();
  int interpolation = inputs[3].toInt();
  ...
  try {
    ...
    error("Uncaught exception occurred in remap");
  }
