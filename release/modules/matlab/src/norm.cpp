...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("norm");
  parser.addVariant("norm", 2, 2, "normType", "mask");
  ...
  int normType = inputs[2].empty() ? (int) NORM_L2 : inputs[2].toInt();
  ...
  try {
    ...
    error("Uncaught exception occurred in norm");
  }
