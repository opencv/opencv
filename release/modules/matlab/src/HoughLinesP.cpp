...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("HoughLinesP");
  parser.addVariant("HoughLinesP", 4, 2, "minLineLength", "maxLineGap");
  ...
  double minLineLength = inputs[4].empty() ? (double) 0 : inputs[4].toDouble();
  double maxLineGap = inputs[5].empty() ? (double) 0 : inputs[5].toDouble();
  Mat lines;
  ...
  try {
    ...
    error("Uncaught exception occurred in HoughLinesP");
  }
