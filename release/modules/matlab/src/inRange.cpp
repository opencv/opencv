...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("inRange");
  parser.addVariant("inRange", 3, 0);
  ...
  Mat lowerb = inputs[1].toMat();
  Mat upperb = inputs[2].toMat();
  Mat dst;
  ...
  try {
    ...
    error("Uncaught exception occurred in inRange");
  }
