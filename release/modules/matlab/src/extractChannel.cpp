...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("extractChannel");
  parser.addVariant("extractChannel", 2, 0);
  ...
  try {
    ...
    error("Uncaught exception occurred in extractChannel");
  }
