...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("undistort");
  parser.addVariant("undistort", 3, 1, "newCameraMatrix");
  ...
  Mat newCameraMatrix = inputs[3].empty() ? (Mat) Mat() : inputs[3].toMat();
  Mat dst;
  ...
  try {
    ...
    error("Uncaught exception occurred in undistort");
  }
