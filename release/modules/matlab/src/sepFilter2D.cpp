...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("sepFilter2D");
  parser.addVariant("sepFilter2D", 4, 3, "anchor", "delta", "borderType");
  ...
  Mat kernelX = inputs[2].toMat();
  Mat kernelY = inputs[3].toMat();
  Point anchor = inputs[4].empty() ? (Point) Point(-1,-1) : inputs[4].toPoint();
  ...
  try {
    ...
    error("Uncaught exception occurred in sepFilter2D");
  }
