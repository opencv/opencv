...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("matchShapes");
  parser.addVariant("matchShapes", 4, 0);
  ...
  Mat contour1 = inputs[0].toMat();
  Mat contour2 = inputs[1].toMat();
  int method = inputs[2].toInt();
  double parameter = inputs[3].toDouble();
  double retval;
  ...
  try {
    ...
    error("Uncaught exception occurred in matchShapes");
  }
