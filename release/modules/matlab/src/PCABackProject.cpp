...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("PCABackProject");
  parser.addVariant("PCABackProject", 3, 0);
  ...
  Mat eigenvectors = inputs[2].toMat();
  Mat result;
  ...
  try {
    ...
    error("Uncaught exception occurred in PCABackProject");
  }
