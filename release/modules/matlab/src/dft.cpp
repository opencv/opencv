...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("dft");
  parser.addVariant("dft", 1, 2, "flags", "nonzeroRows");
  ...
  int nonzeroRows = inputs[2].empty() ? (int) 0 : inputs[2].toInt();
  Mat dst;
  ...
  try {
    ...
    error("Uncaught exception occurred in dft");
  }
