...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("createTonemapMantiuk");
  parser.addVariant("createTonemapMantiuk", 0, 3, "gamma", "scale", "saturation");
  ...
  float scale = inputs[1].empty() ? (float) 0.7f : inputs[1].toFloat();
  ...
  try {
    ...
    error("Uncaught exception occurred in createTonemapMantiuk");
  }
