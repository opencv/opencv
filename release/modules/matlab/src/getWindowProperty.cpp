...
/*
 * getWindowProperty
 * double getWindowProperty(String winname, int prop_id);
 * Gateway routine
...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("getWindowProperty");
  parser.addVariant("getWindowProperty", 2, 0);
  ...
  try {
    ...
    error("Uncaught exception occurred in getWindowProperty");
  }
