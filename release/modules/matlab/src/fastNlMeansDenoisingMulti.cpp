...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("fastNlMeansDenoisingMulti");
  parser.addVariant("fastNlMeansDenoisingMulti", 4, 3, "templateWindowSize", "searchWindowSize", "normType");
  ...
  vector_float h = inputs[3].toVectorFloat();
  int templateWindowSize = inputs[4].empty() ? (int) 7 : inputs[4].toInt();
  int searchWindowSize = inputs[5].empty() ? (int) 21 : inputs[5].toInt();
  int normType = inputs[6].empty() ? (int) NORM_L2 : inputs[6].toInt();
  Mat dst;
  ...
  try {
    ...
    error("Uncaught exception occurred in fastNlMeansDenoisingMulti");
  }
