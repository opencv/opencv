...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("bilateralFilter");
  parser.addVariant("bilateralFilter", 4, 1, "borderType");
  ...
  int d = inputs[1].toInt();
  double sigmaColor = inputs[2].toDouble();
  double sigmaSpace = inputs[3].toDouble();
  ...
  try {
    ...
    error("Uncaught exception occurred in bilateralFilter");
  }
