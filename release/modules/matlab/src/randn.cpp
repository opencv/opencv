...
/*
 * randn
 * void randn(Mat dst, Mat mean, Mat stddev);
 * Gateway routine
...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("randn");
  parser.addVariant("randn", 3, 0);
  ...
  try {
    ...
    error("Uncaught exception occurred in randn");
  }
