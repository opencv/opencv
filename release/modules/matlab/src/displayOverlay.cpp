...
void mexFunction(int nlhs, mxArray**,
  ...
  // parse the inputs
  ArgumentParser parser("displayOverlay");
  parser.addVariant("displayOverlay", 2, 1, "delayms");
  ...
  try {
    ...
    error("Uncaught exception occurred in displayOverlay");
  }
