...
/*
 * randu
 * void randu(Mat dst, Mat low, Mat high);
 * Gateway routine
...
void mexFunction(int nlhs, mxArray* plhs[],
  ...
  // parse the inputs
  ArgumentParser parser("randu");
  parser.addVariant("randu", 3, 0);
  ...
  Mat dst = inputs[0].toMat();
  Mat low = inputs[1].toMat();
  Mat high = inputs[2].toMat();
  ...
  try {
    ...
    error("Uncaught exception occurred in randu");
  }
