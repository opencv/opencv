...
GAPI_OCV_KERNEL_ST(RenderFrameNV12OCVImpl, cv::gapi::wip::draw::GRenderFrameNV12, RenderOCVState)
{
...
{
    const static auto pkg = cv::gapi::kernels<RenderBGROCVImpl, RenderNV12OCVImpl, RenderFrameNV12OCVImpl>();
    return pkg;
}
