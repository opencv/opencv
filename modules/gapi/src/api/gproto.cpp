...
cv::GMetaArg cv::descr_of(const cv::GRunArg &arg)
{
    switch (arg.index())
    {
        ...
        case GRunArg::index_of<cv::Scalar>():
            return cv::GMetaArg(cv::descr_of(util::get<cv::Scalar>(arg)));
...
cv::GMetaArg cv::descr_of(const cv::GRunArgP &argp)
{
    ...
    case GRunArgP::index_of<cv::Scalar*>():            return GMetaArg(cv::descr_of(*util::get<cv::Scalar*>(argp)));
...
bool cv::can_describe(const GMetaArg& meta, const GRunArg& arg)
{
    ...
    {
#if !defined(GAPI_STANDALONE)
    case GRunArg::index_of<cv::UMat>():              return meta == cv::GMetaArg(cv::descr_of(util::get<cv::UMat>(arg)));
#endif //  !defined(GAPI_STANDALONE)
    ...
    case GRunArg::index_of<cv::Scalar>():            return meta == cv::GMetaArg(cv::descr_of(util::get<cv::Scalar>(arg)));
