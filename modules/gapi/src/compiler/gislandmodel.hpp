...
public:
    ...
    // It seems that ade::NodeHandle needs to be added to the signature for azure case
    virtual cv::gapi::own::RMat allocate(const cv::GMatDesc&) const { GAPI_Assert(false && "should never be called"); }
