 ...
 *
 * @snippet samples/cpp/tutorial_code/gapi/api_ref_snippets/api_ref_snippets.cpp graph_decl_apply
 *
 * Extra parameter specifying which kernels to compile with can be
 * passed like this:
 *
 * @snippet samples/cpp/tutorial_code/gapi/api_ref_snippets/api_ref_snippets.cpp apply_with_param
 */
