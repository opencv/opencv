...
namespace detail
{
    ...
    using GOpaqueTraitsArrayTypes = std::tuple<int, double, float, uint64_t, bool, cv::Size, cv::Scalar, cv::Point,
    ...
    using GOpaqueTraitsOpaqueTypes = std::tuple<int, double, float, uint64_t, bool, cv::Size, cv::Point, cv::Rect,
