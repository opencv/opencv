 ...
 *
 * @snippet samples/cpp/tutorial_code/gapi/api_ref_snippets/api_ref_snippets.cpp graph_def
 *
 * Full pipeline can be now captured with this object declaration:
 *
 * @snippet samples/cpp/tutorial_code/gapi/api_ref_snippets/api_ref_snippets.cpp graph_cap_full
 *
 ...
 * defined like this:
 *
 * @snippet samples/cpp/tutorial_code/gapi/api_ref_snippets/api_ref_snippets.cpp graph_cap_sub
 *
...
public:
     ...
     *
     * @snippet samples/cpp/tutorial_code/gapi/api_ref_snippets/api_ref_snippets.cpp graph_gen
     *
