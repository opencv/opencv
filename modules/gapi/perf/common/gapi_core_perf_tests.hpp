...
//------------------------------------------------------------------------------
    ...
    class BottleneckKernelsConstInputPerfTest : public TestPerfParams<tuple<compare_f, cv::GCompileArgs>> {};
    class ResizeFxFyPerfTest : public TestPerfParams<tuple<compare_f, MatType, int, cv::Size, double, double, cv::GCompileArgs>> {};
    class BottleneckKernelsPerfTest : public TestPerfParams<tuple<compare_f, MatType, cv::Size, cv::GCompileArgs>> {};
