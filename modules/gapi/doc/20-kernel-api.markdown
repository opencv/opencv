...
@snippet samples/cpp/tutorial_code/gapi/kernel_api_snippets/kernel_api_snippets.cpp filter2d_on
...
@snippet samples/cpp/tutorial_code/gapi/kernel_api_snippets/kernel_api_snippets.cpp filter2d_wrap

so now it can be used like:

@snippet samples/cpp/tutorial_code/gapi/kernel_api_snippets/kernel_api_snippets.cpp filter2d_wrap_call
...
@snippet samples/cpp/tutorial_code/gapi/kernel_api_snippets/kernel_api_snippets.cpp filter2d_ocv
...
@snippet samples/cpp/tutorial_code/gapi/kernel_api_snippets/kernel_api_snippets.cpp compound
