...
*** G-API enables a streaming execution mode since v4.2
...
- Initial Python3 binding is available now in ~master~ (future v4.5);
...
*** Streaming and the heterogeneous execution
