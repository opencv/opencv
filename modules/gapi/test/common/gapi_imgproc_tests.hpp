...
GAPI_TEST_FIXTURE_SPEC_PARAMS(FindContoursTest, FIXTURE_API(cv::Size,MatType2,int,int),
                              4, sz, type, mode, method)
GAPI_TEST_FIXTURE_SPEC_PARAMS(FindContoursHierarchicalTest, FIXTURE_API(cv::Size,MatType2,int,int),
                              4, sz, type, mode, method)
