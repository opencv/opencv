...
static const char* const moduleName = "gapi";

struct cv::ocl::internal::ProgramEntry symm7x7_test_oclsrc={moduleName, "symm7x7_test",
"#if BORDER_REPLICATE\n"
...
"}\n"
, "f16315a649bd151012ef5a167ec434a7", NULL};
