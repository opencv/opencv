...
{
    cv::RNG_MT19937 rng(5489);
    int actual[64] = {0, };
    const size_t length = (sizeof(actual) / sizeof(actual[0]));
    for (int i = 0; i < 16384; ++i)
        actual[rng.next() % length]++;

    int expected[length] =
    {
        230, 260, 237, 250, 277, 289, 256, 249,
        243, 232, 233, 244, 280, 251, 281, 250,
        262, 266, 274, 272, 259, 224, 239, 244,
        267, 257, 263, 264, 256, 280, 239, 257,
        243, 287, 247, 237, 235, 254, 265, 250,
        249, 248, 259, 259, 261, 277, 307, 266,
        260, 273, 243, 227, 263, 224, 243, 258,
        263, 235, 260, 240, 249, 245, 274, 298,
    };
