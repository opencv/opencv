...
open class OpenCVTestCase: XCTestCase {
    ...
    func assertSizeEquals(_ expected:CVSize,_ actual: CVSize,_ eps: Double, file: StaticString = #file, line: UInt = #line) {
    ...
    func assertPointEquals(_ expected:CVPoint, _ actual: CVPoint, _ eps: Double, file: StaticString = #file, line: UInt = #line) {
        let msg = "expected:<\(expected)> but was:<\(actual)>"
