...
DEF_CVT_SCALE_ABS_FUNC(16f8u, cvtabs_32f, fp16_t, uchar, float)
...
DEF_CVT_SCALE_FUNC(16f8u,  cvt_32f, fp16_t, uchar, float)
...
DEF_CVT_SCALE_FUNC(16f8s,  cvt_32f, fp16_t, schar, float)
...
DEF_CVT_SCALE2BOOL_FUNC(16f8b, fp16_t, float)
...
DEF_CVT_SCALE_FUNC(16f16u, cvt1_32f, fp16_t, ushort, float)
...
DEF_CVT_SCALE_FUNC(16f16s, cvt1_32f, fp16_t, short, float)
...
DEF_CVT_SCALE_FUNC(16f32u, cvt1_32f, fp16_t, unsigned, float)
...
DEF_CVT_SCALE_FUNC(16f32s, cvt1_32f, fp16_t, int, float)
...
DEF_CVT_SCALE_FUNC(16f32f, cvt1_32f, fp16_t, float, float)
...
DEF_CVT_SCALE_FUNC(16f64f, cvt_64f, fp16_t, double, double)
...
DEF_CVT_SCALE_FUNC(16f64u, cvt_64f, fp16_t, uint64_t, double)
...
DEF_CVT_SCALE_FUNC(16f64s, cvt_64f, fp16_t, int64_t, double)
DEF_CVT_SCALE_FUNC(16bf64s, cvt_64f, bfloat16_t, int64_t, double)

DEF_CVT_SCALE_FUNC(8u16f,  cvt1_32f, uchar,  fp16_t, float)
DEF_CVT_SCALE_FUNC(8s16f,  cvt1_32f, schar,  fp16_t, float)
DEF_CVT_SCALE_FUNC(16u16f, cvt1_32f, ushort, fp16_t, float)
DEF_CVT_SCALE_FUNC(16s16f, cvt1_32f, short,  fp16_t, float)
DEF_CVT_SCALE_FUNC(32u16f, cvt1_32f, unsigned, fp16_t, float)
DEF_CVT_SCALE_FUNC(32s16f, cvt1_32f, int,    fp16_t, float)
DEF_CVT_SCALE_FUNC(32f16f, cvt1_32f, float,  fp16_t, float)
DEF_CVT_SCALE_FUNC(64f16f, cvt1_32f, double, fp16_t, float)
DEF_CVT_SCALE_FUNC(64u16f, cvt1_32f, uint64_t, fp16_t, float)
DEF_CVT_SCALE_FUNC(64s16f, cvt1_32f, int64_t, fp16_t, float)
DEF_CVT_SCALE_FUNC(16f,    cvt1_32f, fp16_t, fp16_t, float)
DEF_CVT_SCALE_FUNC(16bf16f, cvt1_32f, bfloat16_t, fp16_t, float)
...
DEF_CVT_SCALE_FUNC(16f16bf, cvt1_32f, fp16_t, bfloat16_t, float)
...
DEF_CVT_SCALEBOOL2_FUNC(8b16f, fp16_t, float)
