...
DEFINE_MINMAXIDX_FUNC(minMaxIdx16f, f32, u32, fp16_t, unsigned, v_float32, v_uint32, float, vx_load_expand)
...
//DEFINE_MINMAXIDX_FUNC_NOSIMD(minMaxIdx16f, fp16_t, float)
