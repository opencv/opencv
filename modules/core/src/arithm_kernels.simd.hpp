...
// through CV_CPU_DISPATCH) live in arithm_kernels.dispatch.cpp.
//
...
//      arithm_kernels.dispatch.cpp reach them through CV_CPU_DISPATCH). ----
...
TKernel getAbsdiffFunc_(int T, int rdepth)
{
    ...
    case CV_8S:   fptr = scalarBinaryKernel<schar,    uchar,    short,   EwAbsdiff>; break;
    case CV_16S:  fptr = scalarBinaryKernel<short,    ushort,   int,     EwAbsdiff>; break;
    case CV_32U:  fptr = scalarBinaryKernel<unsigned, unsigned, int64_t, EwAbsdiff>; break;
    case CV_32S:  fptr = scalarBinaryKernel<int,      unsigned, int64_t, EwAbsdiff>; break;
...
static KernelFunc compareByType(int T)
{
    ...
    case CV_16F:  return scalarCompareKernel<hfloat,   float,    Cmp>;
    case CV_16BF: return scalarCompareKernel<bfloat,   float,    Cmp>;
...
// get*Func() forwarders live in arithm_kernels.dispatch.cpp.
// ===========================================================================
