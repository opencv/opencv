...
static inline void vx_load_as(const fp16_t* ptr, v_float32& a)
...
static inline void v_store_as(fp16_t* ptr, const v_float32& a)
{ v_pack_store(ptr, a); }
...
static inline void vx_load_pair_as(const fp16_t* ptr, v_float32& a, v_float32& b)
{
    a = vx_load_expand(ptr);
...
static inline void vx_load_pair_as(const fp16_t* ptr, v_float64& a, v_float64& b)
{
...
static inline void v_store_pair_as(fp16_t* ptr, const v_float64& a, const v_float64& b)
{
    v_float32 v = v_cvt_f32(a, b);
    v_pack_store(ptr, v);
}
