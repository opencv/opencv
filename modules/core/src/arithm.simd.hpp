...
#define DECLARE_SIMPLE_BINARY_OP_ALLTYPES(opname) \
    ...
    DECLARE_SIMPLE_BINARY_OP(opname##16f, fp16_t); \
...
#define DECLARE_SCALED_BINARY_OP_ALLTYPES(opname, scale_arg) \
    ...
    DECLARE_SCALED_BINARY_OP(opname##16f, fp16_t, scale_arg); \
...
#define DEFINE_SIMPLE_BINARY_OP_ALLTYPES(opname, scalar_op, scalar_op_u64, vec_op) \
    ...
    DEFINE_SIMPLE_BINARY_OP_16F(opname##16f, fp16_t, scalar_op, vec_op) \
...
DEFINE_SIMPLE_BINARY_OP_16F(absdiff16f, fp16_t, scalar_absdiff, v_absdiff)
...
#define DEFINE_CMP_OP_ALLTYPES(opname, scalar_op, vec_op) \
    ...
    DEFINE_CMP_OP_16F(opname##16f, fp16_t, scalar_op, vec_op) \
...
#define DEFINE_SCALED_OP_ALLTYPES(opname, scale_arg, iscalar_op, fscalar_op, ivec_op, fvec_op, init, when_binary) \
    ...
    DEFINE_SCALED_OP_16F(opname##16f, scale_arg, fp16_t, fscalar_op, fvec_op, init##_f32, when_binary) \
...
#define DEFINE_BINARY_OP_DISPATCHER_ALLTYPES(opname) \
    ...
    DEFINE_BINARY_OP_DISPATCHER(opname##16f, cv_hal_f16, fp16_t) \
...
DEFINE_CMP_OP_DISPATCHER(cmp16f, cv_hal_f16, fp16_t)
...
#define DEFINE_BINARY_OP_W_PARAMS_DISPATCHER_ALLTYPES(opname, read_params, paramname) \
    ...
    DEFINE_BINARY_OP_W_PARAMS_DISPATCHER(opname##16f, cv_hal_f16, fp16_t, read_params, paramname) \
...
DEFINE_UNARY_OP_W_PARAMS_DISPATCHER(recip16f, cv_hal_f16, fp16_t, double scale = *(double*)params_, scale)
