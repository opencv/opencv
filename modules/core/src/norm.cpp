        ...
        && cols > 0 && (size_t)rows*cols == total_size )
    {
        ...
        else
        {
            ...
            ippiNormFuncHint ippiNormHint =
                ...
                0) :
                normType == NORM_L2 || normType == NORM_L2SQR ?
                (type == CV_32F ? (ippiNormFuncHint)ippiNorm_L2_32f_C1R :
                0) : 0;
            ippiNormFuncNoHint ippiNorm =
                normType == NORM_INF ?
                (type == CV_8U ? (ippiNormFuncNoHint)ippiNorm_Inf_8u_C1R :
                type == CV_16U ? (ippiNormFuncNoHint)ippiNorm_Inf_16u_C1R :
                type == CV_16S ? (ippiNormFuncNoHint)ippiNorm_Inf_16s_C1R :
                type == CV_32F ? (ippiNormFuncNoHint)ippiNorm_Inf_32f_C1R :
                0) :
                normType == NORM_L1 ?
                (type == CV_8U ? (ippiNormFuncNoHint)ippiNorm_L1_8u_C1R :
                type == CV_16U ? (ippiNormFuncNoHint)ippiNorm_L1_16u_C1R :
                type == CV_16S ? (ippiNormFuncNoHint)ippiNorm_L1_16s_C1R :
                0) :
                normType == NORM_L2 || normType == NORM_L2SQR ?
                (type == CV_8U ? (ippiNormFuncNoHint)ippiNorm_L2_8u_C1R :
                type == CV_16U ? (ippiNormFuncNoHint)ippiNorm_L2_16u_C1R :
                type == CV_16S ? (ippiNormFuncNoHint)ippiNorm_L2_16s_C1R :
                0) : 0;
