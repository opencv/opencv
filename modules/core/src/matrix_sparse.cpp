...
static ConvertData getConvertElem(int fromType, int toType)
{
    ...
    */
    static ConvertData tab[CV_DEPTH_MAX][CV_DEPTH_MAX] =
    {
        {
            /*CV_8U*/
            convertData_<uchar, uchar>, convertData_<uchar, schar>, convertData_<uchar, ushort>, convertData_<uchar, short>,
            convertData_<uchar, int>, convertData_<uchar, float>, convertData_<uchar, double>, NULL,
            convertData_<uchar, uint>, convertData_<uchar, uint64_t>, NULL, convertData_<uchar, int64_t>,
            NULL, NULL, NULL, convertData_<uchar, schar>,
            convertData_<uchar, short>, convertData_<uchar, int>, convertData_<uchar, int64_t>, NULL,
            NULL, convertData_<uchar, uchar>, convertData_<uchar, ushort>, convertData_<uchar, uint>,
            convertData_<uchar, uint64_t>, NULL, NULL, NULL,
            NULL, NULL, NULL, NULL,
        },
        {
            /*CV_8S*/
            convertData_<schar, uchar>, convertData_<schar, schar>, convertData_<schar, ushort>, convertData_<schar, short>,
            convertData_<schar, int>, convertData_<schar, float>, convertData_<schar, double>, NULL,
            convertData_<schar, uint>, convertData_<schar, uint64_t>, NULL, convertData_<schar, int64_t>,
            NULL, NULL, NULL, convertData_<schar, schar>,
            convertData_<schar, short>, convertData_<schar, int>, convertData_<schar, int64_t>, NULL,
            NULL, convertData_<schar, uchar>, convertData_<schar, ushort>, convertData_<schar, uint>,
            convertData_<schar, uint64_t>, NULL, NULL, NULL,
            NULL, NULL, NULL, NULL,
        },
        {
            /*CV_16U*/
            convertData_<ushort, uchar>, convertData_<ushort, schar>, convertData_<ushort, ushort>, convertData_<ushort, short>,
            convertData_<ushort, int>, convertData_<ushort, float>, convertData_<ushort, double>, NULL,
            convertData_<ushort, uint>, convertData_<ushort, uint64_t>, NULL, convertData_<ushort, int64_t>,
            NULL, NULL, NULL, convertData_<ushort, schar>,
            convertData_<ushort, short>, convertData_<ushort, int>, convertData_<ushort, int64_t>, NULL,
            NULL, convertData_<ushort, uchar>, convertData_<ushort, ushort>, convertData_<ushort, uint>,
            convertData_<ushort, uint64_t>, NULL, NULL, NULL,
            NULL, NULL, NULL, NULL,
        },
        {
            /*CV_16S*/
            convertData_<short, uchar>, convertData_<short, schar>, convertData_<short, ushort>, convertData_<short, short>,
            convertData_<short, int>, convertData_<short, float>, convertData_<short, double>, NULL,
            convertData_<short, uint>, convertData_<short, uint64_t>, NULL, convertData_<short, int64_t>,
            NULL, NULL, NULL, convertData_<short, schar>,
            convertData_<short, short>, convertData_<short, int>, convertData_<short, int64_t>, NULL,
            NULL, convertData_<short, uchar>, convertData_<short, ushort>, convertData_<short, uint>,
            convertData_<short, uint64_t>, NULL, NULL, NULL,
            NULL, NULL, NULL, NULL,
        },
        {
            /*CV_32S*/
            convertData_<int, uchar>, convertData_<int, schar>, convertData_<int, ushort>, convertData_<int, short>,
            convertData_<int, int>, convertData_<int, float>, convertData_<int, double>, NULL,
            convertData_<int, uint>, convertData_<int, uint64_t>, NULL, convertData_<int, int64_t>,
            NULL, NULL, NULL, convertData_<int, schar>,
            convertData_<int, short>, convertData_<int, int>, convertData_<int, int64_t>, NULL,
            NULL, convertData_<int, uchar>, convertData_<int, ushort>, convertData_<int, uint>,
            convertData_<int, uint64_t>, NULL, NULL, NULL,
            NULL, NULL, NULL, NULL,
        },
        {
            /*CV_32F*/
            convertData_<float, uchar>, convertData_<float, schar>, convertData_<float, ushort>, convertData_<float, short>,
            convertData_<float, int>, convertData_<float, float>, convertData_<float, double>, NULL,
            convertData_<float, uint>, convertData_<float, uint64_t>, NULL, convertData_<float, int64_t>,
            NULL, NULL, NULL, NULL,
            NULL, NULL, NULL, NULL,
            NULL, NULL, NULL, NULL,
            NULL, NULL, NULL, NULL,
        ...
        {
            /*CV_64F*/
            convertData_<double, uchar>, convertData_<double, schar>, convertData_<double, ushort>, convertData_<double, short>,
            convertData_<double, int>, convertData_<double, float>, convertData_<double, double>, NULL,
            convertData_<double, uint>, convertData_<double, uint64_t>, NULL, convertData_<double, int64_t>,
            NULL, NULL, NULL, NULL,
            NULL, NULL, NULL, NULL,
            NULL, NULL, NULL, NULL,
            NULL, NULL, NULL, NULL,
        ...
        {
            /*CV_32U*/
            convertData_<uint, uchar>, convertData_<uint, schar>, convertData_<uint, ushort>, convertData_<uint, short>,
            convertData_<uint, int>, convertData_<uint, float>, convertData_<uint, double>, NULL,
            convertData_<uint, uint>, convertData_<uint, uint64_t>, NULL, convertData_<uint, int64_t>,
            NULL, NULL, NULL, convertData_<uint, schar>,
            convertData_<uint, short>, convertData_<uint, int>, convertData_<uint, int64_t>, NULL,
            NULL, convertData_<uint, uchar>, convertData_<uint, ushort>, convertData_<uint, uint>,
            convertData_<uint, uint64_t>, NULL, NULL, NULL,
            NULL, NULL, NULL, NULL,
        },
        {
            /*CV_64U*/
            convertData_<uint64_t, uchar>, convertData_<uint64_t, schar>, convertData_<uint64_t, ushort>, convertData_<uint64_t, short>,
            convertData_<uint64_t, int>, convertData_<uint64_t, float>, convertData_<uint64_t, double>, NULL,
            convertData_<uint64_t, uint>, convertData_<uint64_t, uint64_t>, NULL, convertData_<uint64_t, int64_t>,
            NULL, NULL, NULL, convertData_<uint64_t, schar>,
            convertData_<uint64_t, short>, convertData_<uint64_t, int>, convertData_<uint64_t, int64_t>, NULL,
            NULL, convertData_<uint64_t, uchar>, convertData_<uint64_t, ushort>, convertData_<uint64_t, uint>,
            convertData_<uint64_t, uint64_t>, NULL, NULL, NULL,
            NULL, NULL, NULL, NULL,
        },
        {
            NULL, NULL, NULL, NULL,
        ...
        {
            /*CV_64S*/
            convertData_<int64_t, uchar>, convertData_<int64_t, schar>, convertData_<int64_t, ushort>, convertData_<int64_t, short>,
            convertData_<int64_t, int>, convertData_<int64_t, float>, convertData_<int64_t, double>, NULL,
            convertData_<int64_t, uint>, convertData_<int64_t, uint64_t>, NULL, convertData_<int64_t, int64_t>,
            NULL, NULL, NULL, convertData_<int64_t, schar>,
            convertData_<int64_t, short>, convertData_<int64_t, int>, convertData_<int64_t, int64_t>, NULL,
            NULL, convertData_<int64_t, uchar>, convertData_<int64_t, ushort>, convertData_<int64_t, uint>,
            convertData_<int64_t, uint64_t>, NULL, NULL, NULL,
            NULL, NULL, NULL, NULL,
        },
        {
            NULL, NULL, NULL, NULL,
