...
DEF_CVT_FUNC(8u16f, cvt1_, uchar, fp16_t, v_float32)
...
DEF_CVT_FUNC(8s16f, cvt1_, schar, fp16_t, v_float32)
...
DEF_CVTBOOL2_FUNC(8b16f, uint16_t, 0x3c00) // fp16_t(1.0f)
...
DEF_CVT_FUNC(16u16f, cvt1_,ushort, fp16_t, v_float32)
...
DEF_CVT_FUNC(16s16f, cvt1_,short, fp16_t, v_float32)
...
DEF_CVT_FUNC(32u16f, cvt1_, unsigned, fp16_t, v_float32)
...
DEF_CVT_FUNC(32s16f, cvt1_,int, fp16_t, v_float32)
...
DEF_CVT_FUNC(32f16f, cvt1_,float, fp16_t, v_float32)
...
DEF_CVT_FUNC(64f16f, cvt1_,double, fp16_t, v_float32)
DEF_CVT_FUNC(64f16bf, cvt1_,double, bfloat16_t, v_float32)
DEF_CVT2BOOL_FUNC(64f8b, int64_t, 1)

////////////////////// 16f -> ... ////////////////////////

DEF_CVT_FUNC(16f8u,  cvt_,  fp16_t, uchar,  v_float32)
DEF_CVT_FUNC(16f8s,  cvt_,  fp16_t, schar,  v_float32)
DEF_CVT_FUNC(16f16u, cvt1_, fp16_t, ushort, v_float32)
DEF_CVT_FUNC(16f16s, cvt1_, fp16_t, short,  v_float32)
DEF_CVT_FUNC(16f32u, cvt1_, fp16_t, unsigned, v_float32)
DEF_CVT_FUNC(16f32s, cvt1_, fp16_t, int,    v_float32)
DEF_CVT_FUNC(16f32f, cvt1_, fp16_t, float,  v_float32)
DEF_CVT_FUNC(16f64f, cvt1_, fp16_t, double, v_float32)
DEF_CVT_FUNC(16f64u, cvt1_, fp16_t, uint64_t, v_float32)
DEF_CVT_FUNC(16f64s, cvt1_, fp16_t, int64_t, v_float32)
DEF_CVT_FUNC(16f16bf, cvt1_, fp16_t, bfloat16_t, v_float32)
...
DEF_CVT_FUNC(16bf16f, cvt1_, bfloat16_t, fp16_t, v_float32)
...
DEF_CVT_FUNC(64s16f, cvt1_,int64_t, fp16_t, v_float32)
...
DEF_CVT_FUNC(64u16f, cvt1_,uint64_t, fp16_t, v_float32)
