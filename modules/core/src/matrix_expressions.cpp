...
public:
    ...
    void assign(const MatExpr& expr, Mat& m, int depth = CV_DEPTH_AUTO) const CV_OVERRIDE;
...
void MatOp_Identity::assign(const MatExpr& e, Mat& m, int _depth) const
{
...
void MatOp_AddEx::assign(const MatExpr& e, Mat& m, int _depth) const
{
    if (_depth == CV_DEPTH_AUTO)
        _depth = e.a.depth();
...
void MatOp_Bin::assign(const MatExpr& e, Mat& m, int _depth) const
{
    if (_depth == CV_DEPTH_AUTO)
        _depth = e.a.depth();
...
void MatOp_Cmp::assign(const MatExpr& e, Mat& m, int _depth) const
{
    if (_depth == CV_DEPTH_AUTO)
        _depth = e.a.depth();
...
void MatOp_T::assign(const MatExpr& e, Mat& m, int _depth) const
{
    if (_depth == CV_DEPTH_AUTO)
        _depth = e.a.depth();
...
void MatOp_GEMM::assign(const MatExpr& e, Mat& m, int _depth) const
{
    if (_depth == CV_DEPTH_AUTO)
        _depth = e.a.depth();
...
void MatOp_Invert::assign(const MatExpr& e, Mat& m, int _depth) const
{
    if (_depth == CV_DEPTH_AUTO)
        _depth = e.a.depth();
...
void MatOp_Solve::assign(const MatExpr& e, Mat& m, int _depth) const
{
    if (_depth == CV_DEPTH_AUTO)
        _depth = e.a.depth();
...
void MatOp_Initializer::assign(const MatExpr& e, Mat& m, int _depth) const
{
    if (_depth == CV_DEPTH_AUTO)
        _depth = e.a.depth();
