...
#if !defined CV_DISABLE_OPTIMIZATION && defined CV_ENABLE_INTRINSICS && defined CV_CPU_COMPILE_DOTPROD
#  define CV_TRY_DOTPROD 1
#  define CV_CPU_FORCE_DOTPROD 1
#  define CV_CPU_HAS_SUPPORT_DOTPROD 1
#  define CV_CPU_CALL_DOTPROD(fn, args) return (cpu_baseline::fn args)
#  define CV_CPU_CALL_DOTPROD_(fn, args) return (opt_DOTPROD::fn args)
#elif !defined CV_DISABLE_OPTIMIZATION && defined CV_ENABLE_INTRINSICS && defined CV_CPU_DISPATCH_COMPILE_DOTPROD
#  define CV_TRY_DOTPROD 1
#  define CV_CPU_FORCE_DOTPROD 0
#  define CV_CPU_HAS_SUPPORT_DOTPROD (cv::checkHardwareSupport(CV_CPU_DOTPROD))
#  define CV_CPU_CALL_DOTPROD(fn, args) if (CV_CPU_HAS_SUPPORT_DOTPROD) return (opt_DOTPROD::fn args)
#  define CV_CPU_CALL_DOTPROD_(fn, args) if (CV_CPU_HAS_SUPPORT_DOTPROD) return (opt_DOTPROD::fn args)
#else
#  define CV_TRY_DOTPROD 0
#  define CV_CPU_FORCE_DOTPROD 0
#  define CV_CPU_HAS_SUPPORT_DOTPROD 0
#  define CV_CPU_CALL_DOTPROD(fn, args)
#  define CV_CPU_CALL_DOTPROD_(fn, args)
#endif
#define __CV_CPU_DISPATCH_CHAIN_DOTPROD(fn, args, mode, ...)  CV_CPU_CALL_DOTPROD(fn, args); __CV_EXPAND(__CV_CPU_DISPATCH_CHAIN_ ## mode(fn, args, __VA_ARGS__))
