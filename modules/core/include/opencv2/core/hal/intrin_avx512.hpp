...
// 16 >> 32
inline v_int32x16 v_dotprod(const v_int16x32& a, const v_int16x32& b, const bool ignore_order = false)
{
...
inline v_int32x16 v_dotprod(const v_int16x32& a, const v_int16x32& b,
                            const v_int32x16& c,  const bool ignore_order = false)
{ return v_dotprod(a, b, ignore_order) + c; }

// 32 >> 64
inline v_int64x8 v_dotprod(const v_int32x16& a, const v_int32x16& b, const bool ignore_order = false)
{
    CV_UNUSED(ignore_order);
...
inline v_int64x8 v_dotprod(const v_int32x16& a, const v_int32x16& b,
                           const v_int64x8& c,  const bool ignore_order = false)
{ return v_dotprod(a, b, ignore_order) + c; }

// 8 >> 32
inline v_uint32x16 v_dotprod_expand(const v_uint8x64& a, const v_uint8x64& b, const bool ignore_order = false)
{
    CV_UNUSED(ignore_order);
...
inline v_uint32x16 v_dotprod_expand(const v_uint8x64& a, const v_uint8x64& b,
                                    const v_uint32x16& c, const bool ignore_order = false)
{ return v_dotprod_expand(a, b, ignore_order) + c; }

inline v_int32x16 v_dotprod_expand(const v_int8x64& a, const v_int8x64& b, const bool ignore_order = false)
{
    CV_UNUSED(ignore_order);
...
// 16 >> 64
inline v_uint64x8 v_dotprod_expand(const v_uint16x32& a, const v_uint16x32& b, const bool ignore_order = false)
{
...
inline v_uint64x8 v_dotprod_expand(const v_uint16x32& a, const v_uint16x32& b,
                                   const v_uint64x8& c, const bool ignore_order = false)
{ return v_dotprod_expand(a, b, ignore_order) + c; }

inline v_int64x8 v_dotprod_expand(const v_int16x32& a, const v_int16x32& b, const bool ignore_order = false)
{
    CV_UNUSED(ignore_order);
...
// 32 >> 64f
inline v_float64x8 v_dotprod_expand(const v_int32x16& a, const v_int32x16& b, const bool ignore_order = false)
{
    return v_cvt_f64(v_dotprod(a, b, ignore_order));
}
inline v_float64x8 v_dotprod_expand(const v_int32x16& a,   const v_int32x16& b,
                                    const v_float64x8& c, const bool ignore_order = false)
{ return v_dotprod_expand(a, b, ignore_order) + c; }
