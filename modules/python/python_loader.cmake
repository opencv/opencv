...
if(DEFINED OPENCV_PYTHON_INSTALL_PATH)
  if(IS_ABSOLUTE "${OPENCV_PYTHON_INSTALL_PATH}")
    ...
    set(CMAKE_PYTHON_EXTENSION_INSTALL_PATH_BASE "${OpenCV_PYTHON_INSTALL_PATH_RELATIVE_CONFIGCMAKE}")
  endif()
else()
  set(CMAKE_PYTHON_EXTENSION_INSTALL_PATH_BASE "not_installed")
endif()
...
if(NOT OpenCV_FOUND)  # Ignore "standalone" builds of Python bindings
  ...
  string(REPLACE ";" ":" CMAKE_PYTHON_BINARIES_PATH "${CMAKE_PYTHON_BINARIES_PATH}")
  configure_file("${PYTHON_SOURCE_DIR}/package/template/config.ini.in" "${__loader_path}/cv2/config.ini" @ONLY)

  # install
  if(DEFINED OPENCV_PYTHON_INSTALL_PATH)
    if(WIN32)
      file(TO_NATIVE_PATH "${CMAKE_PYTHON_EXTENSION_INSTALL_PATH_BASE}/${OPENCV_BIN_INSTALL_PATH}" cmake_python_install_path)
      list(APPEND CMAKE_PYTHON_BINARIES_INSTALL_PATH ${cmake_python_install_path})
    else()
      file(TO_NATIVE_PATH "${CMAKE_PYTHON_EXTENSION_INSTALL_PATH_BASE}/${OPENCV_LIB_INSTALL_PATH}" cmake_python_install_path)
      list(APPEND CMAKE_PYTHON_BINARIES_INSTALL_PATH ${cmake_python_install_path})
    endif()
    string(REPLACE ";" ":" CMAKE_PYTHON_BINARIES_PATH "${CMAKE_PYTHON_BINARIES_INSTALL_PATH}")
    configure_file("${PYTHON_SOURCE_DIR}/package/template/config.ini.in" "${__python_loader_install_tmp_path}/cv2/config.ini" @ONLY)
    install(FILES "${__python_loader_install_tmp_path}/cv2/config.ini" DESTINATION "${OPENCV_PYTHON_INSTALL_PATH}/cv2/" COMPONENT python)
  endif()
endif()
