...
if(NOT OPENCV_SKIP_PYTHON_LOADER)
  ...
  if(DEFINED ${PYTHON}_VERSION_MINOR)
    set(__target_config "config-${${PYTHON}_VERSION_MAJOR}.${${PYTHON}_VERSION_MINOR}.ini")
  else()
    set(__target_config "config-${${PYTHON}_VERSION_MAJOR}.ini")
  endif()
  ...
  configure_file("${PYTHON_SOURCE_DIR}/package/template/config-x.y.ini.in" "${__loader_path}/cv2/${__target_config}" @ONLY)
  ...
  if(IS_ABSOLUTE __python_binary_install_path)
    ...
    if(NOT CMAKE_PYTHON_EXTENSION_INSTALL_PATH_BASE STREQUAL "")
      file(TO_NATIVE_PATH "${CMAKE_PYTHON_EXTENSION_INSTALL_PATH_BASE}/${OpenCV_PYTHON_BINARY_RELATIVE_INSTALL_PATH}" CMAKE_PYTHON_EXTENSION_PATH)
    else()
      set(CMAKE_PYTHON_EXTENSION_PATH ${OpenCV_PYTHON_BINARY_RELATIVE_INSTALL_PATH})
    endif()
  endif()
  configure_file("${PYTHON_SOURCE_DIR}/package/template/config-x.y.ini.in" "${__python_loader_install_tmp_path}/cv2/${__target_config}" @ONLY)
