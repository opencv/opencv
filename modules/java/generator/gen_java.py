...
class JavaWrapperGenerator(object):
    ...
    def gen_func(self, ci, fi, prop_name=''):
        ...
        # c_decl
        # e.g: void add(Mat src1, Mat src2, Mat dst, Mat mask = Mat(), ElemType ddepth = CV_TYPE_AUTO)
        if prop_name:
        ...
        while True:
            ...
            # e.g.
            # private static native void add_0(long src1, long src2, long dst, long mask, ElemType ddepth);
            ...
            # e.g.
            # public static void add( Mat src1, Mat src2, Mat dst, Mat mask, ElemType ddepth )
