...
void printHelp()
{
    cout << "OpenCV video stabilizer.\n"
    		...
    		"      Filter out all motions starting from a specific frame. The defaut is no.\n"
            "  -q, --quiet\n"
...
int main(int argc, const char **argv)
{
    try
    {
        ...
        string inputPath = argv[1]; //arg("1") check what happens here
        if (inputPath.empty())
        ...
        {
        	stabilizer->setStartingFrame(argi("zero-motions"));
