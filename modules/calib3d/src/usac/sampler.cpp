...
*/
        ...
        public:
            ...
            void setSampleNumber(int k)
            {
                ...
                { // Increment the size of the sampling pool while required
        ...
        public:
            ...
            ProgressiveNapsacImpl(int state, int points_size_, int sample_size_,
                                  const std::vector<Ptr<NeighborhoodGraph>> &layers_, int sampler_length_) : // initialize one-point prosac sampler and global prosac sampler
            ...
            void generateSample(std::vector<int> &sample) override
            {
                ...
                do
                { // Try to find the grid which contains enough points
        ...
        public:
            NapsacSamplerImpl(int state, int points_size_, int sample_size_,
                              const Ptr<NeighborhoodGraph> &neighborhood_graph_) : neighborhood_graph(neighborhood_graph_),
