...
class GammaValuesImpl : public GammaValues {
    ...
    int max_size_table;
public:
    GammaValuesImpl (int max_size_table_) {
    ...
    Ptr<GammaValues> clone () const override { return makePtr<GammaValuesImpl>(max_size_table); }
};
Ptr<GammaValues> GammaValues::create(int max_size_table) {
    return makePtr<GammaValuesImpl>(max_size_table);
}
}}