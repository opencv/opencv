...
namespace cv
{
    namespace usac
    {
        ...
        GammaValues::GammaValues()
            : max_range_complete(4.62), max_range_gamma(1.52), max_size_table(3000)
        {
            /*
     ...
     */
            ...
            std::vector<double> gamma_complete_anchor = std::vector<double>{1.7724538509055159, 1.182606138403832, 0.962685372890749, 0.8090013493715409,
            ...
            std::vector<double> gamma_incomplete_anchor = std::vector<double>{0.0, 0.01773096912803939, 0.047486924846289004, 0.08265437835139826, 0.120639343491371,
            ...
            std::vector<double> gamma_anchor = std::vector<double>{1.7724538509055159, 1.427187162582056, 1.2890382454046982, 1.186244737282388,
