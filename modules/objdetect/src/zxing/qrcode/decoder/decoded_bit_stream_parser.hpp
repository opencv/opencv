...
#ifndef __ZXING_QRCODE_DECODER_DECODED_BIT_STREAM_PARSER_HPP__
#define __ZXING_QRCODE_DECODER_DECODED_BIT_STREAM_PARSER_HPP__
...
#endif  // __ZXING_QRCODE_DECODER_DECODED_BIT_STREAM_PARSER_HPP__
