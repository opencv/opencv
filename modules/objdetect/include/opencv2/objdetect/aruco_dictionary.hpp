...
enum PredefinedDictionaryType {
    ...
    DICT_6X6_250,           ///< 6x6 bits, minimum hamming distance between any two codes = , 250 codes
    ...
    DICT_7X7_250,           ///< 7x7 bits, minimum hamming distance between any two codes = 17, 250 codes11
