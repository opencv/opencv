...
This 3D Widget defines a point cloud. ::
    ...
    public:
        ...
        //! Each point in cloud is mapped to a color in colors, normals used for shading
        WCloud(InputArray cloud, InputArray colors, InputArray normals);
        //! All points in cloud have the same color, normals used for shading
...
.. ocv:function:: WCloud(InputArray cloud, InputArray colors, InputArray normals)
    ...
    :param cloud: Set of points which can be of type: ``CV_32FC3``, ``CV_32FC4``, ``CV_64FC3``, ``CV_64FC4``.
    :param colors: Set of colors. It has to be of the same size with cloud.
    :param normals: Normals for each point clouds. Size and type should match with cloud parameter.
