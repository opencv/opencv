...
class calibration_test(NewOpenCVTests):
    ...
    def test_calibration(self):
        ...
        for fn in img_names:
            ...
            h, w = img.shape[:2]
            found, corners = cv.calib.findChessboardCorners(img, pattern_size)
            if found:
        ...
        rms, camera_matrix, dist_coefs, _rvecs, _tvecs = cv.calib.calibrateCamera(obj_points, img_points, (w, h), None, None, flags = 0)
