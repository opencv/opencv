...
.. ocv:function:: void adaptiveBilateralFilter( InputArray src, OutputArray dst, Size ksize, double sigmaSpace, double sigmaColor = 20.0, Point anchor=Point(-1, -1), int borderType=BORDER_DEFAULT )
