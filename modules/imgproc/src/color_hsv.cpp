...
struct HSV2RGB_f
{
                        ...
                        v_float32x4& v_v, v_float32x4& v_scale) const
    {
        ...
        v_float32x4 v_one = v_float32x4(1.0f, 1.0f, 1.0f, 1.0f);
        v_float32x4 v_tab1 = v_v * (v_one - v_s);
        v_float32x4 v_tab2 = v_v * (v_one - (v_s * v_h));
        v_float32x4 v_tab3 = v_v * (v_one - (v_s * (v_one - v_h)));

        v_float32x4 v_six = v_float32x4(6.0f, 6.0f, 6.0f, 6.0f);
        v_float32x4 v_sector = v_pre_sector / v_six;
        v_sector = v_cvt_f32(v_trunc(v_sector));
        v_sector = v_pre_sector - (v_sector * v_six);

        v_float32x4 v_two = v_float32x4(2.0f, 2.0f, 2.0f, 2.0f);
        v_h = v_tab1 & (v_sector < v_two);
        v_h = v_h | (v_tab3 & (v_sector == v_two));
        v_float32x4 v_three = v_float32x4(3.0f, 3.0f, 3.0f, 3.0f);
        v_h = v_h | (v_tab0 & (v_sector == v_three));
        v_float32x4 v_four = v_float32x4(4.0f, 4.0f, 4.0f, 4.0f);
    ...
    void operator()(const float* src, float* dst, int n) const
    {
        ...
        if (hasSIMD)
        {
            v_float32x4 v_scale = v_float32x4(hscale, hscale, hscale, hscale);
            if (dcn == 3)
            {
                if (bidx)
                {
                ...
                v_float32x4 v_a = v_float32x4(alpha, alpha, alpha, alpha);
                if (bidx)
                {
                    for (; i <= n - 12; i += 12, dst += dcn * 4)
                    {
