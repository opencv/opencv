...
TEST(Imgproc_Subdiv2D_Insert, regression_22902)
{
    const float points[10][2] = {
        { -1.18061450447522f,   2.22044604925031E-16f },
        {  0.199999999989984f,  1.38061450446519f     },
        {  1.58061450445518f,  -2.22044604925031E-16f },
        { -1.08061450447519f,   1.11022302462516E-16f },
        {  0.199999999989984f, -1.28061450446519f     },
        {  0.199999999989984f,  1.28061450446519f     },
        {  1.48061450445516f,  -1.11022302462516E-16f },
        { -1.18061450447522f,   0.f                   },
        {  1.48061450445516f,   0.f                   },
        { -0.440307252242633f,  1.10904469332167f     }
    };
    std::vector<cv::Point2f> pts;
