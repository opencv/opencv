      ...
      if(OrbbecSDK_FOUND)
        ...
        if(WIN32)
          ...
          if(MSVC_IDE)
            ...
            file(COPY ${OrbbecSDK_DLL_FILES} DESTINATION ${LIBRARY_OUTPUT_PATH}/Release)
            file(COPY ${OrbbecSDK_DLL_FILES} DESTINATION ${LIBRARY_OUTPUT_PATH}/Debug)
          elseif(MSVC AND (CMAKE_GENERATOR MATCHES "Visual"))
            ...
            file(COPY ${OrbbecSDK_DLL_FILES} DESTINATION ${LIBRARY_OUTPUT_PATH}/${CMAKE_BUILD_TYPE})
          else()
