...
public:
    ...
    virtual Ptr<IVideoCapture> createCapture(std::streambuf& source, const VideoCaptureParameters& params) const = 0;
...
typedef Ptr<IVideoCapture> (*FN_createCaptureBuffer)(std::streambuf& source);
...
typedef Ptr<IVideoCapture> (*FN_createCaptureBufferWithParams)(std::streambuf& source, const VideoCaptureParameters& params);
