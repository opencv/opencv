...
Ptr<IVideoCapture> cvCreateStreamCapture_FFMPEG_proxy(const Ptr<IReadStream>& stream, const VideoCaptureParameters& params);
...
Ptr<IVideoCapture> cvCreateCapture_MSMF(const Ptr<IReadStream>& stream, const VideoCaptureParameters& params);
