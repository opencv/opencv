...
Ptr<IVideoCapture> PluginBackend::createCapture(const std::vector<uchar>&, const VideoCaptureParameters&) const
{
    CV_Error(Error::StsNotImplemented, "Capture by buffer with plugin");
}
