...
TEST(Imgcodecs_WebP, ReadWriteWithExifXmpIccp)
{
    ...
    // generated by chatGPT using promt "generate minimal iccp profile"
    static const uchar iccp_data[] = {
        ...
        'm','n','t','r',                                // Device class: 'mntr'
        'R','G','B',' ',                                // Color space: 'RGB '
        'X','Y','Z',' ',                                // PCS: 'XYZ '
        0x00, 0x00, 0x00, 0x00,                         // Creation date (ignored)
        'a','c','s','p',                                // File signature
        ...
        0x00, 0x00, 0x00, 0x00,                         // Rendering intent = 0 (perceptual)
        0x00, 0x01, 0x00, 0x00,                         // Illuminant X = 1.0
        ...
        'd','e','s','c',                                // Tag signature
        0x00, 0x00, 0x00, 0x80,                         // Offset = 128
        0x00, 0x00, 0x00, 0x48,                         // Size = 72

        // ---- Tag Data (72 bytes @ offset 128) ----
