...
namespace opencv_test { namespace {
    ...
    static std::vector<uint8_t> generate_iccp_data() {
        // generated by chatGPT
        std::vector<uint8_t> iccp_data(132, 0);

        // [0–3] Profile size
        uint32_t profile_size = 132;
        iccp_data[0] = (profile_size >> 24) & 0xFF;
        iccp_data[1] = (profile_size >> 16) & 0xFF;
        iccp_data[2] = (profile_size >> 8) & 0xFF;
        iccp_data[3] = (profile_size) & 0xFF;

        // [4–7] CMM type
        iccp_data[4] = 'L'; iccp_data[5] = 'i'; iccp_data[6] = 'n'; iccp_data[7] = 'o';

        // [8–11] Version
        iccp_data[8] = 0x02; iccp_data[9] = 0x40;

        // [12–15] Device class
        iccp_data[12] = 'm'; iccp_data[13] = 'n'; iccp_data[14] = 't'; iccp_data[15] = 'r';

        // [16–19] Color space
        iccp_data[16] = 'R'; iccp_data[17] = 'G'; iccp_data[18] = 'B'; iccp_data[19] = ' ';

        // [20–23] PCS
        iccp_data[20] = 'X'; iccp_data[21] = 'Y'; iccp_data[22] = 'Z'; iccp_data[23] = ' ';

        // [36–39] Signature = 'acsp'
        iccp_data[36] = 'a'; iccp_data[37] = 'c'; iccp_data[38] = 's'; iccp_data[39] = 'p';

        // [68–79] PCS illuminant (X, Y, Z) = D50
        iccp_data[68] = 0x00; iccp_data[69] = 0x00; iccp_data[70] = 0xF6; iccp_data[71] = 0xD6; // X
        iccp_data[72] = 0x00; iccp_data[73] = 0x01; iccp_data[74] = 0x00; iccp_data[75] = 0x00; // Y
        iccp_data[76] = 0x00; iccp_data[77] = 0x00; iccp_data[78] = 0xD3; iccp_data[79] = 0x2D; // Z
...
TEST(Imgcodecs_Png, ReadWriteWithText)
{
    ...
    std::vector<int> metadata_types = { IMAGE_METADATA_EXIF, IMAGE_METADATA_XMP, IMAGE_METADATA_TEXT, IMAGE_METADATA_ICCP};
    std::vector<std::vector<uchar>> metadata = {
        getSampleExifData(),
        getSampleXmpData(),
        getSampleTextData(),
