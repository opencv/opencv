...
#ifndef OPENCV_DNN_WGPU_OP_POOL_HPP
#define OPENCV_DNN_WGPU_OP_POOL_HPP
...
enum PoolType { wPoolTypeAvg, wPoolTypeMax, wPoolTypeNum };
...
#endif // OPENCV_DNN_WGPU_OP_POOL_HPP