    ...
    public:
            ...
            csl::Workspace& workspace) override
        {
            ...
            if (inputs.size() == 2)
            {
                ...
                case EltwiseOpType::IMOD: kernels::eltwise_imod_2<T>(stream, output, input_x, input_y); break;
            ...
            else
            {
                ...
                for (int i = 1; i < inputs.size(); i++)
                {
                    ...
                    case EltwiseOpType::IMOD: kernels::eltwise_imod_2<T>(stream, output, output, input); break;
