...
void initSPVMaps()
{
    ...
    SPVMaps.insert(std::make_pair("nary_eltwise_binary_forward_spv", std::make_pair(nary_eltwise_binary_forward_spv, 1753)));
    SPVMaps.insert(std::make_pair("nary_eltwise_nary_forward_spv", std::make_pair(nary_eltwise_nary_forward_spv, 2419)));
    SPVMaps.insert(std::make_pair("nary_eltwise_trinary_forward_spv", std::make_pair(nary_eltwise_trinary_forward_spv, 2419)));
}
