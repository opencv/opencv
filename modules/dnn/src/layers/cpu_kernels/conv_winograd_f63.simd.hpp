                        ...
                        const int winoIblock, const int winoKblock, const int winoAtomF16, const int winoNatomF16)
{
    ...
    const hfloat* inwptr = (const hfloat*)_inwptr;
    const hfloat* wptr = (const hfloat*)_wptr;
    hfloat* outbuf = (hfloat*)_outbuf;
...
{
    typedef __fp16 hfloat;
    const hfloat* inptr = (const hfloat*)_inptr;
