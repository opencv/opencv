                        ...
                        const int winoIblock, const int winoKblock, const int winoAtomF16, const int winoNatomF16)
{
    ...
    const fp16_t* inwptr = (const fp16_t*)_inwptr;
    const fp16_t* wptr = (const fp16_t*)_wptr;
    fp16_t* outbuf = (fp16_t*)_outbuf;
...
{
    typedef __fp16 fp16_t;
    const fp16_t* inptr = (const fp16_t*)_inptr;
