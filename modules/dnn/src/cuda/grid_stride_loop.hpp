...
#ifndef OPENCV_DNN_CUDA4DNN_SRC_CUDA_GRID_STRIDE_LOOP_HPP
#define OPENCV_DNN_CUDA4DNN_SRC_CUDA_GRID_STRIDE_LOOP_HPP
...
namespace cv { namespace dnn { namespace cuda4dnn { namespace csl {
    ...
    template <int dim, class index_type = gpu::index_type, class size_type = gpu::size_type>
...
#endif /* OPENCV_DNN_CUDA4DNN_SRC_CUDA_GRID_STRIDE_LOOP_HPP */
