...
{
    std::cout << "Node proto domain: " << node_proto.domain() << std::endl;
    ...
    std::cout << "layer_type_domain: " << layer_type_domain << std::endl;
    std::cout << "Customly parsing the layer without explicit dispatch map" << std::endl;
