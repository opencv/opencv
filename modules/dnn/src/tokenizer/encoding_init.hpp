...
/*
    [ERROR]: libc++abi: terminating due to uncaught exception of type std::runtime_error: Unknown byte in encoder.json: Ń
    from the function loadTokenizerBPE need to look into this
*/
