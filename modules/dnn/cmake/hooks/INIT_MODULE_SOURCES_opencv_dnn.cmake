...
if(NOT HAVE_METAL)
  message(STATUS "opencv_dnn: filter out Metal source code")
  ocv_list_filterout(OPENCV_MODULE_${the_module}_SOURCES "/metal/")
  ocv_list_filterout(OPENCV_MODULE_${the_module}_HEADERS "/metal/")
endif()
