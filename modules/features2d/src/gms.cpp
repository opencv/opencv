...
private:
    ...
    static int mRotationPatterns[8][9];

    // 5 level scales
    static double mScaleRatios[5];
...
// 8 possible rotation and each one is 3 X 3
int gms_matcher::mRotationPatterns[8][9] = {
    1,2,3,
    4,5,6,
    7,8,9,
...
// 5 level scales
double gms_matcher::mScaleRatios[5] = { 1.0, 1.0 / 2, 1.0 / sqrt(2.0), sqrt(2.0), 2.0 };
