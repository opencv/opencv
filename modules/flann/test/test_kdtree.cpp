...
// Maximum acceptable failure counts for each search mode.
// Chosen conservatively to catch real regressions while tolerating the
// known imprecision of KDTree approximate and exact searches.
static const KDTreeTestCase kAccuracyCases[] = {
    // name,               N,      dim, k,  n_q,  radius,  seed, range, exact, approx, radius_w
    { "standard_3D",       10000,  3,   10, 50,   200,     42,   1000,  24,    107,    50  },
    { "small_dataset",     15,     3,   5,  200,  50,      7,    500,   15,    20,     0   },
    { "k_1",               5000,   3,   1,  30,   200,     11,   1000,  3,     3,      10  },
    { "large_k_50",        1000,   3,   50, 100,  50,      17,   500,   60,    110,    1   },
    { "k_eq_N",            20,     3,   20, 9999, 30,      23,   100,   0,     0,      5   },
    { "high_dim_64",       2000,   64,  10, 50,   50,      31,   10,    0,     50,     0   },
    { "large_radius",      5000,   3,   10, 2000, 50,      37,   1000,  250,   1000,   60  },
    { "tiny_radius",       5000,   3,   10, 1,    100,     41,   1000,  16,    60,     0   },
    { "dim_2D",            8000,   2,   10, 30,   200,     53,   500,   48,    74,     160 },
    { "many_trees_4",      5000,   3,   10, 50,   100,     59,   1000,  15,    58,     5   },
};
