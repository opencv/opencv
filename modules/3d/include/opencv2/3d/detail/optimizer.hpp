...
public:
    ...
    // calculates an inital solution for poses using Minimum Spanning Tree ( Prim's MST) algorithm
    // This solution should be used as a starting point for optimization
    virtual void initializePosesWithMST() = 0;
