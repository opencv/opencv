...
.. ocv:function:: void ocl::adaptiveBilateralFilter(const oclMat& src, oclMat& dst, Size ksize, double sigmaSpace, double sigmaColor = 20.0, Point anchor = Point(-1, -1), int borderType=BORDER_DEFAULT)
