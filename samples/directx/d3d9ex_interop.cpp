...
public:
    ...
    int create(void)
    {
        ...
        r = m_pD3D9Ex->CreateDeviceEx(D3DADAPTER_DEFAULT, D3DDEVTYPE_HAL, m_hWnd, flags, &d3dpp, nullptr, &m_pD3D9DevEx);
        if (FAILED(r))
        {
            return EXIT_FAILURE;
        }
        ...
        r = m_pD3D9DevEx->CreateOffscreenPlainSurface(m_width, m_height, D3DFMT_A8R8G8B8, D3DPOOL_DEFAULT, &m_pSurface, nullptr);
        if (FAILED(r))
        {
    ...
    int render()
    {
        try
        {
            ...
            r = m_pD3D9DevEx->StretchRect(pSurface, nullptr, m_pBackBuffer, nullptr, D3DTEXF_NONE);
            if (FAILED(r))
            {
                return EXIT_FAILURE;
            }
            ...
            r = m_pD3D9DevEx->Present(nullptr, nullptr, nullptr, nullptr);
            if (FAILED(r))
            {
                return EXIT_FAILURE;
            }
