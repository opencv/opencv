...
class Stitcher:
    ...
    def stitch(self):
        self.prepare_medium_resolution_imgs()
        self.find_features()
        self.match_features()
        self.select_images_and_matches_subset()
        self.estimate_camera_parameters()
        self.refine_camera_parameters()
        self.perform_wave_correction()
        self.estimate_scale_of_final_panorama()
        self.warp_images()
        self.estimate_exposure_errors()
        self.compensate_exposure_errors()
        self.find_seam_masks()
        self.resize_masks_to_final_resolution()
        self.blend_images
