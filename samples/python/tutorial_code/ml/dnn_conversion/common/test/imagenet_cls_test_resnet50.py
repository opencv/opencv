...
from ..accuracy_eval import ClsAccEvaluation
from ..utils import plot_acc


def test_cls_models(models_list, data_fetcher, eval_params, experiment_name, is_print_eval_params=True,
                    is_plot_acc=True):
    ...
    accuracy_evaluator = ClsAccEvaluation(eval_params.log, eval_params.img_cls_file, eval_params.batch_size)
