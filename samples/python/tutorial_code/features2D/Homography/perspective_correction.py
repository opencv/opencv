...
def main():
    ...
    parser.add_argument('-H', "--height", help="Height of pattern size", default=9)
    parser.add_argument('-W', "--width", help="Width of pattern size", default=6)
    ...
    h = args.height
    w = args.width
    perspectiveCorrection(img1Path, img2Path, (h, w))
