...
| [OpenCV face detector](https://github.com/opencv/opencv/tree/3.4/samples/data/face_detector) | `1.0` | `300x300` | `104 177 123` | BGR |
...
#### Face detection
[An origin model](https://github.com/opencv/opencv/tree/3.4/samples/data/face_detector)
