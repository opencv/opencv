...
Scalar getMSSIM_CUDA( const Mat& i1, const Mat& i2)
{
    ...
    Ptr<cuda::Filter> gauss = cuda::createGaussianFilter(vI2[0].type(), CV_TYPE_AUTO, Size(11, 11), 1.5);
...
Scalar getMSSIM_CUDA_optimized( const Mat& i1, const Mat& i2, BufferMSSIM& b)
{
    ...
    Ptr<cuda::Filter> gauss = cuda::createGaussianFilter(b.vI1[0].type(), CV_TYPE_AUTO, Size(11, 11), 1.5);

    for( int i = 0; i < b.gI1.channels(); ++i )
    {
        cuda::multiply(b.vI2[i], b.vI2[i], b.I2_2, 1, CV_DEPTH_AUTO, stream);        // I2^2
        cuda::multiply(b.vI1[i], b.vI1[i], b.I1_2, 1, CV_DEPTH_AUTO, stream);        // I1^2
        cuda::multiply(b.vI1[i], b.vI2[i], b.I1_I2, 1, CV_DEPTH_AUTO, stream);       // I1 * I2

        gauss->apply(b.vI1[i], b.mu1, stream);
        gauss->apply(b.vI2[i], b.mu2, stream);

        cuda::multiply(b.mu1, b.mu1, b.mu1_2, 1, CV_DEPTH_AUTO, stream);
        cuda::multiply(b.mu2, b.mu2, b.mu2_2, 1, CV_DEPTH_AUTO, stream);
        cuda::multiply(b.mu1, b.mu2, b.mu1_mu2, 1, CV_DEPTH_AUTO, stream);

        gauss->apply(b.I1_2, b.sigma1_2, stream);
        cuda::subtract(b.sigma1_2, b.mu1_2, b.sigma1_2, cuda::GpuMat(), CV_DEPTH_AUTO, stream);
        //b.sigma1_2 -= b.mu1_2;  - This would result in an extra data transfer operation

        gauss->apply(b.I2_2, b.sigma2_2, stream);
        cuda::subtract(b.sigma2_2, b.mu2_2, b.sigma2_2, cuda::GpuMat(), CV_DEPTH_AUTO, stream);
        //b.sigma2_2 -= b.mu2_2;

        gauss->apply(b.I1_I2, b.sigma12, stream);
        cuda::subtract(b.sigma12, b.mu1_mu2, b.sigma12, cuda::GpuMat(), CV_DEPTH_AUTO, stream);
        //b.sigma12 -= b.mu1_mu2;

        //here too it would be an extra data transfer due to call of operator*(Scalar, Mat)
        cuda::multiply(b.mu1_mu2, 2, b.t1, 1, CV_DEPTH_AUTO, stream); //b.t1 = 2 * b.mu1_mu2 + C1;
        cuda::add(b.t1, C1, b.t1, cuda::GpuMat(), CV_DEPTH_AUTO, stream);
        cuda::multiply(b.sigma12, 2, b.t2, 1, CV_DEPTH_AUTO, stream); //b.t2 = 2 * b.sigma12 + C2;
        cuda::add(b.t2, C2, b.t2, cuda::GpuMat(), CV_DEPTH_AUTO, stream);

        cuda::multiply(b.t1, b.t2, b.t3, 1, CV_DEPTH_AUTO, stream);     // t3 = ((2*mu1_mu2 + C1).*(2*sigma12 + C2))

        cuda::add(b.mu1_2, b.mu2_2, b.t1, cuda::GpuMat(), CV_DEPTH_AUTO, stream);
        cuda::add(b.t1, C1, b.t1, cuda::GpuMat(), CV_DEPTH_AUTO, stream);

        cuda::add(b.sigma1_2, b.sigma2_2, b.t2, cuda::GpuMat(), CV_DEPTH_AUTO, stream);
        cuda::add(b.t2, C2, b.t2, cuda::GpuMat(), CV_DEPTH_AUTO, stream);


        cuda::multiply(b.t1, b.t2, b.t1, 1, CV_DEPTH_AUTO, stream);     // t1 =((mu1_2 + mu2_2 + C1).*(sigma1_2 + sigma2_2 + C2))
        cuda::divide(b.t3, b.t1, b.ssim_map, 1, CV_DEPTH_AUTO, stream);      // ssim_map =  t3./t1;
