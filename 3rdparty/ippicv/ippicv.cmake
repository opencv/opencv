function(download_ippicv root_var)
  ...
  set(IPPICV_COMMIT "6c3f5a5e20325afa869f01f9b2123731a9124bef")
  ...
  elseif((UNIX AND NOT ANDROID) OR (UNIX AND ANDROID_ABI MATCHES "x86"))
    ...
    if(X86_64)
      set(OPENCV_ICV_NAME "ippicv_2022.2.0_lnx_intel64_20250509_general.tgz")
      set(OPENCV_ICV_HASH "53203f55fcc7f1bf5b91c150383fb4b7")
    else()
      if(ANDROID)
  ...
  elseif(WIN32 AND NOT ARM)
    ...
    if(X86_64)
      set(OPENCV_ICV_NAME "ippicv_2022.2.0_win_intel64_20250509_general.zip")
      set(OPENCV_ICV_HASH "6086cf9ecbfa78b5131628ec8d1981a7")
    else()
      set(IPPICV_COMMIT "7f55c0c26be418d494615afca15218566775c725")
