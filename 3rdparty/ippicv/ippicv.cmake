function(download_ippicv root_var)
  ...
  set(IPPICV_COMMIT "4fe81acdb1688d5f2a3fa6f34b1c28793e706f0b")
  ...
  elseif((UNIX AND NOT ANDROID) OR (UNIX AND ANDROID_ABI MATCHES "x86"))
    ...
    if(X86_64)
      set(OPENCV_ICV_NAME "ippicv_2026.1.0_lnx_intel64_20260922_general.tgz")
      set(OPENCV_ICV_HASH "78f38db04a4d8f08f7d715a5c976347b")
    else()
      if(ANDROID)
  ...
  elseif(WIN32 AND NOT ARM)
    ...
    if(X86_64)
      set(OPENCV_ICV_NAME "ippicv_2026.1.0_win_intel64_20260922_general.zip")
      set(OPENCV_ICV_HASH "d24183f73b413c5b4e2d2b371affc82a")
    else()
      set(IPPICV_COMMIT "7f55c0c26be418d494615afca15218566775c725")
