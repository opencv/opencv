...
static inline int32x2_t vclip(int32x2_t x, int32x2_t a, int32x2_t b)
{
...
{
    const bool isRelative = ((interpolation & WARP_RELATIVE_MAP) != 0);
    ...
    int x, y, x1, y1;
    short* XY = (short*)fastMalloc(BLOCK_SIZE * BLOCK_SIZE * 2 * sizeof(short));
