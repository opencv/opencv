...
xcframework -create-xcframework -framework ./xcframework-build/catalyst/opencv2.framework -framework ./xcframework-build/osx/opencv2.framework -framework ./xcframework-build/iphonesimulator/opencv2.framework -framework ./xcframework-build/iphoneos/opencv2.framework -output ./xcframework-build/opencv2.xcframework