...
if __name__ == "__main__":
    ...
    parser.add_argument('--cmake_option', action='append', help="Append CMake options")    # Use flag --cmake option="-D...=ON" only for one argument, if you wold add more change write new cmake_option flags
    ...
    parser.add_argument('--config', default=os.path.join(os.path.dirname(os.path.abspath(__file__)), 'opencv_js.config.py'), help="Specify configuration file with own list of exported into JS functions") # Write a path to modify file like argument of this flag
