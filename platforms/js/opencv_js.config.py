...
objdetect = {'': ['getPredefinedDictionary', 'extendDictionary',
                  ...
                  'aruco2_detectFiducialMarkers', 'aruco2_detectGridBoard', 'aruco2_drawFiducialMarkers', 'aruco2_getFiducialMarker',
                  'aruco2_getGridBoard', 'aruco2_getDiamondImage', 'aruco2_getFractalImage',
                  'aruco2_getSolvePnpPoints', 'aruco2_estimatePoseBoard', 'aruco2_refineDetected',
                  'aruco2_drawAxis', 'aruco2_drawGridBoard', 'aruco2_detectDiamonds', 'aruco2_drawDiamonds',
                  'aruco2_detectFractals', 'aruco2_drawFractals'],
             ...
             'aruco2_DictionaryType': [],
             'aruco2_FractalType': [],
             'aruco2_FiducialMarker': ['FiducialMarker'],
             'aruco2_GridBoard': ['GridBoard', 'getGridBoard', 'getGridSize', 'getMarkerLength', 'getMarkerSeparation', 'matchImagePoints'],
             'aruco2_Diamond': ['Diamond'],
             'aruco2_FractalMarker': ['FractalMarker'],
             'aruco2_DetectionParameters': ['DetectionParameters'],
