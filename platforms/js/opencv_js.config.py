...
objdetect = {'': ['getPredefinedDictionary', 'extendDictionary',
             ...
             'mcc_CheckerDetector': ['process', 'getBestColorChecker', 'getListColorChecker', 'create', 'draw', 'getRefColors', 'setDetectionParams', 'getDetectionParams', 'setColorChartType', 'getColorChartType', 'setUseNet', 'getUseNet'],
