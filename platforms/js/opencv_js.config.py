...
objdetect = {'': ['getPredefinedDictionary', 'extendDictionary',
                  ...
                  'aruco2_detectFiducialMarkers', 'aruco2_detectGridBoard', 'aruco2_drawFiducialMarkers', 'aruco2_getFiducialMarkerImage',
                  'aruco2_getGridBoardImage', 'aruco2_getDiamondImage', 'aruco2_getFractalMarkerImage',
                  'aruco2_getSolvePnpPoints',
                  'aruco2_drawAxis', 'aruco2_drawGridBoard', 'aruco2_detectDiamonds', 'aruco2_drawDiamonds',
                  'aruco2_detectFractals', 'aruco2_drawFractals', 'aruco2_detectRArucoMarkers', 'aruco2_getRArucoMarkerImage'],
