...
if not self.config.build_debug:
    ...
    copytree(old_div(build_bin_dir, 'inference_engine_nn_builder.lib'), old_div(sysroot_ie_lib_dir, 'inference_engine_nn_builder.lib'))
    ...
    copytree(old_div(build_bin_dir, 'inference_engine_nn_builderd.lib'), old_div(sysroot_ie_lib_dir, 'inference_engine_nn_builderd.lib'))
