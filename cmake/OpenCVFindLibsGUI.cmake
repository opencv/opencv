...
if(WITH_QT)
  if(NOT WITH_QT GREATER 0)
    find_package(QT NAMES Qt6 Qt5 COMPONENTS Core Gui Widgets Test Concurrent NO_MODULE)
    if(NOT QT_FOUND)
      ocv_find_package_Qt4()
    endif()
  elseif(WITH_QT EQUAL 4)
    ocv_find_package_Qt4(REQUIRED)
  else()  # WITH_QT=<major version>
    set(OCV_QT_VER "${WITH_QT}")
    find_package(Qt${OCV_QT_VER} COMPONENTS Core Gui Widgets Test Concurrent REQUIRED NO_MODULE)
