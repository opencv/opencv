...
set(CPU_ALL_OPTIMIZATIONS "SSE;SSE2;SSE3;SSSE3;SSE4_1;SSE4_2;POPCNT;AVX;XOP;FP16;AVX2;FMA3;AVX_512F;AVX512_SKX")
...
if(X86 OR X86_64)
  ocv_update(CPU_KNOWN_OPTIMIZATIONS "SSE;SSE2;SSE3;SSSE3;SSE4_1;POPCNT;SSE4_2;XOP;FP16;FMA3;AVX;AVX2;AVX_512F;AVX512_SKX")
  ...
  ocv_update(CPU_XOP_TEST_FILE "${OpenCV_SOURCE_DIR}/cmake/checks/cpu_xop.cpp")
  ...
  if(NOT OPENCV_CPU_OPT_IMPLIES_IGNORE)
    ...
    ocv_update(CPU_XOP_IMPLIES "AVX")
  ...
  if(CV_ICC)
    ...
    ocv_update(CPU_XOP_SUPPORTED OFF)
  ...
  elseif(CV_GCC OR CV_CLANG)
    ...
    ocv_update(CPU_XOP_FLAGS_ON "-mxop")
