...
elseif(ARM OR AARCH64)
  ...
  ocv_update(CPU_FP16_TEST_FILE "${OpenCV_SOURCE_DIR}/cmake/checks/cpu_fp16.cpp")
  ocv_update(CPU_FP16_SIMD_TEST_FILE "${OpenCV_SOURCE_DIR}/cmake/checks/cpu_fp16_simd.cpp")
  ocv_update(CPU_BF16_SIMD_TEST_FILE "${OpenCV_SOURCE_DIR}/cmake/checks/cpu_bf16_simd.cpp")
  ...
  if(NOT AARCH64)
    ...
    ocv_update(CPU_FP16_SIMD_FLAGS_ON "-march=armv8.2-a+fp16")
    ocv_update(CPU_FP16_SIMD_IMPLIES "NEON")
    ocv_update(CPU_BF16_SIMD_FLAGS_ON "-march=armv8.2-a+fp16+bf16")
    ocv_update(CPU_BF16_SIMD_IMPLIES "NEON")
    set(CPU_BASELINE "NEON;FP16" CACHE STRING "${HELP_CPU_BASELINE}")
    set(CPU_DISPATCH "FP16_SIMD;BF16_SIMD;NEON_DOTPROD" CACHE STRING "${HELP_CPU_DISPATCH}")
  endif()
elseif(MIPS)
