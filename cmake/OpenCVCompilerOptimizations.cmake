...
# AVX512_ICL (Ice Lake with AVX-512F/CD/BW/DQ/VL/IFMA/VBMI/VNNI/VBMI2/BITALG/VPOPCNTDQ)
...
if(X86 OR X86_64)
  ...
  elseif(CV_GCC OR CV_CLANG)
    ...
    if(NOT (CV_GCC AND CMAKE_CXX_COMPILER_VERSION VERSION_LESS "5.0"))  # GCC >= 5.0
      ...
      ocv_update(CPU_AVX512_COMMON_FLAGS_ON "-mavx512cd")
      ocv_update(CPU_AVX512_KNL_FLAGS_ON "-mavx512er -mavx512pf")
      ocv_update(CPU_AVX512_KNM_FLAGS_ON "-mavx5124fmaps -mavx5124vnniw -mavx512vpopcntdq")
      ocv_update(CPU_AVX512_SKX_FLAGS_ON "-mavx512vl -mavx512bw -mavx512dq")
      ocv_update(CPU_AVX512_CNL_FLAGS_ON "-mavx512ifma -mavx512vbmi")
      ocv_update(CPU_AVX512_CEL_FLAGS_ON "-mavx512vnni")
      # gfni?
      ocv_update(CPU_AVX512_ICL_FLAGS_ON "-mavx512vbmi2 -mavx512bitalg -mavx512vpopcntdq")
    else()
      ocv_update(CPU_AVX_512F_SUPPORTED OFF)
      ocv_update(CPU_AVX512_COMMON_SUPPORTED OFF)
      ocv_update(CPU_AVX512_KNL_SUPPORTED OFF)
      ocv_update(CPU_AVX512_KNM_SUPPORTED OFF)
      ocv_update(CPU_AVX512_SKX_SUPPORTED OFF)
      ocv_update(CPU_AVX512_CNL_SUPPORTED OFF)
      ocv_update(CPU_AVX512_CEL_SUPPORTED OFF)
      ocv_update(CPU_AVX512_ICL_SUPPORTED OFF)
    endif()
  elseif(MSVC)
  ...
  if(NOT DEFINED CPU_DISPATCH)
    if(X86_64)
      set(CPU_DISPATCH "SSE4_1;SSE4_2;AVX;FP16;AVX2;AVX512_COMMON;AVX512_KNL;AVX512_KNM;AVX512_SKX;AVX512_CNL;AVX512_CEL;AVX512_ICL" CACHE STRING "${HELP_CPU_DISPATCH}")
    else()
