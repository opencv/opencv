...
elseif(ARM OR AARCH64)
  ...
  if(NOT AARCH64)
    ...
    if(NOT CPU_DISPATCH STREQUAL "")
      message(WARNING "ARM64 doesn't support dispatched code generation yet")
      set(CPU_DISPATCH "")
    endif()
  endif()
elseif(MIPS)
...
elseif(RISCV)
  ...
  if(NOT CPU_BASELINE STREQUAL "DETECT")
    message(WARNING "RISC-V only supports CPU_BASELINE=DETECT, use CMAKE_CXX_FLAGS or cmake toolchain file options to change platform")
    set(CPU_BASELINE "DETECT")
  endif()
  ...
  if(NOT CPU_DISPATCH STREQUAL "")
    ...
    endforeach()
    if(NOT have_flags)
      message(WARNING "Dispatched generation requested (CPU_DISPATCH=${CPU_DISPATCH}), but not all CPU_xxx_FLAGS_ON provided")
    endif()
  endif()
...
foreach(OPT ${CPU_KNOWN_OPTIMIZATIONS})
  ...
  if(CPU_${OPT}_SUPPORTED)
    if(";${CPU_DISPATCH};" MATCHES ";${OPT};" AND NOT __is_from_baseline AND NOT __is_disabled)
