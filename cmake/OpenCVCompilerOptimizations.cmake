...
list(APPEND CPU_ALL_OPTIMIZATIONS RVV RVP052)
...
elseif(RISCV)
  ...
  ocv_update(CPU_RVP052_TEST_FILE "${OpenCV_SOURCE_DIR}/cmake/checks/cpu_rvp052.cpp")
  ocv_update(CPU_KNOWN_OPTIMIZATIONS "RVV;RVP052")
  ocv_update(CPU_RVV_FLAGS_ON "-march=rv64gcv")
  ocv_update(CPU_RVP052_FLAGS_ON "-mext-dsp")
