...
# CPU_{opt}_DISPATCH_SUPPORTED=ON/OFF - indicates dispatch support. Empty / undefined implies supported.
...
elseif(ARM OR AARCH64)
  ...
  ocv_update(CPU_FP16_TEST_FILE "${OpenCV_SOURCE_DIR}/cmake/checks/cpu_fp16.cpp")
  ocv_update(CPU_DOTPROD_TEST_FILE "${OpenCV_SOURCE_DIR}/cmake/checks/cpu_dotprod.cpp")
  ocv_update(CPU_DOTPROD_DISPATCH_SUPPORTED OFF)
  ocv_update(CPU_DOTPROD_IMPLIES "NEON")
  if(NOT AARCH64)
    ocv_update(CPU_KNOWN_OPTIMIZATIONS "VFPV3;NEON;FP16;DOTPROD")
    if(NOT MSVC)
    ...
    ocv_update(CPU_KNOWN_OPTIMIZATIONS "NEON;FP16;DOTPROD")
    ocv_update(CPU_NEON_FLAGS_ON "")
    ocv_update(CPU_FP16_IMPLIES "NEON")
    set(CPU_BASELINE "NEON;FP16;DOTPROD" CACHE STRING "${HELP_CPU_BASELINE}")
  endif()
elseif(MIPS)
...
foreach(OPT ${CPU_KNOWN_OPTIMIZATIONS})
  ...
  if(CPU_${OPT}_SUPPORTED)
    if(";${CPU_DISPATCH};" MATCHES ";${OPT};" AND NOT __is_from_baseline)
      if(DEFINED CPU_${OPT}_DISPATCH_SUPPORTED AND NOT CPU_${OPT}_DISPATCH_SUPPORTED)
        message(SEND_ERROR "Unsupported dispatch optimization ${OPT}.  Please add to CPU_BASELINE instead.")
      else()
