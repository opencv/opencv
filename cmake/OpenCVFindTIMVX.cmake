...
if(ENV{VIVANTE_SDK_DIR})
    set(VIVANTE_SDK_DIR $ENV{VIVANTE_SDK_DIR})
endif()
# If all candidates are found, then set TIMVX_VIV_FOUND on. Otherwise, set it off.
find_vivante_sdk_libs(missing ${VIVANTE_SDK_DIR})
if(missing)
    message(STATUS "TIM-VX: Failed to find ${missing} in ${VIVANTE_SDK_DIR}. Turning off TIMVX_VIV_FOUND")
    set(TIMVX_VIV_FOUND OFF)
else()
    message(STATUS "TIM-VX: VIVANTE SDK libraries are found.")
