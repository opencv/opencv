...
if(NOT OpenBLAS_FOUND)
  ...
  find_path(OpenBLAS_INCLUDE_DIRS NAMES cblas.h PATHS ENV "OpenBLAS" ENV "OpenBLAS_HOME" PATH_SUFFIXES "include" "include/openblas" NO_DEFAULT_PATH)
  find_path(OpenBLAS_LAPACKE_DIR NAMES lapacke.h PATHS "${OpenBLAS_INCLUDE_DIRS}" ENV "OpenBLAS" ENV "OpenBLAS_HOME" PATH_SUFFIXES "include" "include/openblas" NO_DEFAULT_PATH)
...
if(NOT OpenBLAS_FOUND)
  ...
  find_path(OpenBLAS_LAPACKE_DIR NAMES lapacke.h PATHS "${OpenBLAS_INCLUDE_DIRS}" PATH_SUFFIXES openblas)
  if(OpenBLAS_LIBRARIES AND OpenBLAS_INCLUDE_DIRS)
