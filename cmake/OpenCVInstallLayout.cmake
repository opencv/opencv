...
elseif(WIN32 AND CMAKE_HOST_SYSTEM_NAME MATCHES Windows)
  ...
  if(DEFINED OpenCV_ARCH AND DEFINED OpenCV_RUNTIME)
    if (NOT("${OpenCV_ARCH}"    STREQUAL "") AND NOT("${OpenCV_ARCH}"    STREQUAL "."))
        ocv_update(OPENCV_INSTALL_BINARIES_PREFIX "${OpenCV_ARCH}/")
    else()
        ocv_update(OPENCV_INSTALL_BINARIES_PREFIX "")
    endif()
    if (NOT("${OpenCV_RUNTIME}" STREQUAL "") AND NOT("${OpenCV_RUNTIME}" STREQUAL "."))
        set(OPENCV_INSTALL_BINARIES_PREFIX "${OPENCV_INSTALL_BINARIES_PREFIX}${OpenCV_RUNTIME}/")
    endif()
  else()
