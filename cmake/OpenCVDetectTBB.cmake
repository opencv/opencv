...
function(ocv_tbb_cmake_guess _found)
    ...
    if(TBB_FOUND)
      ...
      set(_lib "")
      foreach(_config RELEASE RELWITHDEBINFO MINSIZEREL DEBUG NONE)
        get_target_property(_lib_tmp TBB::tbb IMPORTED_LOCATION_${_config})
        if(_lib_tmp AND NOT _lib_tmp STREQUAL "_lib_tmp-NOTFOUND")
          set(_lib "${_lib_tmp}")
          break()
        endif()
      endforeach()
      ...
      if(NOT _lib)
        get_target_property(_import_configs TBB::tbb IMPORTED_CONFIGURATIONS)
        if(_import_configs)
          list(GET _import_configs 0 _first_config)
          get_target_property(_lib TBB::tbb IMPORTED_LOCATION_${_first_config})
        endif()
      endif()
