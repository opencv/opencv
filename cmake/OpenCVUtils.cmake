...
function(ocv_register_imported_library target library_var libraries_var)
  if("${${libraries_var}}" STREQUAL "${target}")
    return()
  endif()
  if(TARGET "${target}")
    message(FATAL_ERROR "Can't register IMPORTED target, it is already exist: ${target}")
    return()
  endif()
  set(__lib_optimized "")
  set(__lib_debug "")
  set(__lib "")
  set(__selected "")
  foreach(e ${${libraries_var}})
    string(TOLOWER ${e} e_lower)
    if(e_lower STREQUAL "optimized")
      set(__selected "__lib_optimized")
    elseif(e_lower STREQUAL "debug")
      set(__selected "__lib_debug")
    elseif(__selected STREQUAL "")
      list(APPEND __lib ${e})
    else()
      list(APPEND ${__selected} ${e})
    endif()
  endforeach()
  add_library(${target} UNKNOWN IMPORTED)
  if(__lib_optimized)
    set_property(TARGET ${target} APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
    set_target_properties(${target} PROPERTIES IMPORTED_LOCATION_RELEASE ${__lib_optimized})
  endif()
  if(__lib_debug)
    set_property(TARGET ${target} APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
    set_target_properties(${target} PROPERTIES IMPORTED_LOCATION_DEBUG ${__lib_debug})
  endif()
  if(__lib)
    set_target_properties(${target} PROPERTIES IMPORTED_LOCATION ${__lib})
  endif()
  set(${library_var} ${target} PARENT_SCOPE)
  set(${libraries_var} ${target} PARENT_SCOPE)
endfunction()
