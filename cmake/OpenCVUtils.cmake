...
macro(CHECK_MODULE module_name define)
  set(${define} 0)
  if(PKG_CONFIG_FOUND AND (NOT ANDROID OR DEFINED ENV{PKG_CONFIG_LIBDIR}) )
    ...
    if(${ALIAS_FOUND})
      ...
      foreach(L ${${ALIAS_LIBRARIES}})
        find_library(${L}_LIBRARIES ${L} PATHS ${${ALIAS_LIBRARY_DIRS}} NO_DEFAULT_PATH CMAKE_FIND_ROOT_PATH_BOTH)
        find_library(${L}_LIBRARIES ${L})
        list(APPEND HIGHGUI_LIBRARIES ${${L}_LIBRARIES})
      endforeach()
    endif()
  endif()
endmacro()
