...
# similar to target_compile_definitions() call (available in CMake 2.8.11)
function(ocv_target_compile_definitions)
  cmake_parse_arguments(_DEF "" "TARGET" "DEFINE" ${ARGN})
  get_target_property(__DEFINES ${_DEF_TARGET} COMPILE_DEFINITIONS)
  if(__DEFINES MATCHES __DEFINES-NOTFOUND)
    set(__DEFINES "${_DEF_DEFINE}")
  else()
    list(APPEND __DEFINES ${_DEF_DEFINE})
  endif()
  set_target_properties(${_DEF_TARGET} PROPERTIES COMPILE_DEFINITIONS "${__DEFINES}")
endfunction()
