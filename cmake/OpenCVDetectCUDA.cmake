...
if(CUDA_FOUND)
  ...
  if(CUDA_VERSION VERSION_GREATER_EQUAL "11.0")
    ...
    foreach(component IN LISTS CUDA_nppi_LIBRARY)
      if(component MATCHES "nppicom")
        list(REMOVE_ITEM CUDA_nppi_LIBRARY ${component})
      endif()
    endforeach()
    foreach(component IN LISTS CUDA_npp_LIBRARY)
      if(component MATCHES "nppicom")
        list(REMOVE_ITEM CUDA_npp_LIBRARY ${component})
      endif()
    endforeach()
  endif()
