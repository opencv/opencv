...
if(WITH_JPEGXL)
  ...
  if(JPEGXL_FOUND)
    set(HAVE_JPEGXL YES)
    message(STATUS "Found system JPEG-XL: ${JXL_LIBRARIES}")
  else()
    ocv_clear_vars(JXL_LIBRARY JXL_LIBRARIES JXL_INCLUDE_DIR)
    message(STATUS "Could NOT find JPEG-XL (libjxl). JPEG-XL will be built from sources")
    add_subdirectory("${OpenCV_SOURCE_DIR}/3rdparty/libjxl")
    set(JXL_LIBRARY jxl CACHE INTERNAL "")
    set(JXL_LIBRARIES ${JXL_LIBRARY})
    set(JXL_INCLUDE_DIR "${${JXL_LIBRARY}_SOURCE_DIR}" CACHE INTERNAL "")
    set(JXL_INCLUDE_DIRS ${JXL_INCLUDE_DIR})
    set(HAVE_JPEGXL YES)
    message(STATUS "JPEG-XL libraries will be built from sources: ${JXL_LIBRARIES}")
  endif()
endif()
