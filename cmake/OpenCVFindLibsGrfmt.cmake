...
if(WITH_PNG AND NOT IOS)
  if(BUILD_PNG)
    ...
    if(PNG_FOUND)
      ...
      check_include_file("${PNG_PNG_INCLUDE_DIR}/libpng/pnginfo.h" HAVE_LIBPNG_PNGINFO_H)
      check_include_file("${PNG_PNG_INCLUDE_DIR}/pnginfo.h" HAVE_PNGINFO_H)
  ...
  if(NOT PNG_FOUND)
    ocv_clear_vars(PNG_LIBRARY PNG_LIBRARIES PNG_INCLUDE_DIR PNG_PNG_INCLUDE_DIR HAVE_LIBPNG_PNG_H HAVE_LIBPNG_PNGINFO_H HAVE_PNGINFO_H PNG_DEFINITIONS)
