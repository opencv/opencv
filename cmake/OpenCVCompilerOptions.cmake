...
if(UNIX AND NOT APPLE)
  # adds relative path to Linux binaries. This allow to make this binaries movable.
  # lib folder should be placed near the bin folder to make this work
  set(OPENCV_EXTRA_EXE_LINKER_FLAGS "${OPENCV_EXTRA_EXE_LINKER_FLAGS} -Wl,-rpath,$ORIGIN/../lib")
endif()
