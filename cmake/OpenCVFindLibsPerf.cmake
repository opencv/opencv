...
if(WITH_FASTCV)
  if((ARM OR AARCH64) AND (ANDROID OR (UNIX AND NOT APPLE AND NOT IOS AND NOT XROS)))
    ...
    unset(WITH_FASTCV)
    unset(FCV_ENABLE)
    message(FATAL_ERROR "FastCV HAL supports ARM Platform on Android and Linux only!")
  endif((ARM OR AARCH64) AND (ANDROID OR (UNIX AND NOT APPLE AND NOT IOS AND NOT XROS)))
else()
  unset(FCV_ENABLE)
endif(WITH_FASTCV)