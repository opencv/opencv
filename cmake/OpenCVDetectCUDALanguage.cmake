...
if(CMAKE_CUDA_COMPILER AND CUDAToolkit_FOUND)
  ...
  # Extract only major.minor to avoid overly strict patch version matching (issue #26965)
  # CUDAToolkit_VERSION may include patch (e.g., 12.3.107), but we only need major.minor (e.g., 12.3)
  # This is consistent with FindCUDA.cmake behavior
  string(REGEX MATCH "^[0-9]+\\.[0-9]+" CUDA_VERSION_STRING "${CUDAToolkit_VERSION}")
