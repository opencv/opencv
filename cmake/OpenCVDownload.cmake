...
macro(ocv_download_set_url_and_md5sum pkg_url pkg_owner pkg_name pkg_md5sum new_md5sum)
  if(NOT ${pkg_url})
    if(OPENCV_MIRROR_FOR_GITHUB_ARCHIVE)
      set(${pkg_url} "${OPENCV_MIRROR_FOR_GITHUB_ARCHIVE}/") # make sure it ends with "/"
...
function(ocv_init_download)
  ...
  if(NOT OCV_GIT_ORIGIN_URL_OUT)
    ...
    if(OPENCV_MIRROR_FOR_GITHUB_ARCHIVE)
        message(STATUS "ocv_init_download: Use ${OPENCV_MIRROR_FOR_GITHUB_ARCHIVE} as mirror to download 3rdparty archives.")
        set(OPENCV_MIRROR_FOR_GITHUB_ARCHIVE "${OPENCV_MIRROR_FOR_GITHUB_ARCHIVE};archive" PARENT_SCOPE)
    endif()
    if(OPENCV_MIRROR_FOR_GITHUBUSERCONTENT)
        message(STATUS "ocv_init_download: Use ${OPENCV_MIRROR_FOR_GITHUBUSERCONTENT} as mirror to download 3rdparty raw files.")
