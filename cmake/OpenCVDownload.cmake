...
function(ocv_init_download)
  ...
  if(NOT OCV_GIT_ORIGIN_URL_OUT)
    ...
    if(OPENCV_DOWNLOAD_HOST STREQUAL "GITHUB")
      message(STATUS "ocv_init_download: Try -DOPENCV_MIRROR_CUSTOM=gitcode.net if connection to Github.com is poor.")
    elseif()
      message(STATUS "ocv_init_download: Use mirror ${OPENCV_DOWNLOAD_HOST} to download 3rdparty resources.")
    endif()
  endif()
endfunction()
