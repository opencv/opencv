...
class Blender:
    ...
    def feed(self, img, mask, corner):
        """https://docs.opencv.org/5.x/d6/d4a/classcv_1_1detail_1_1Blender.html#a64837308bcf4e414a6219beff6cbe37a"""  # noqa
        self.blender.feed(cv.UMat(img.astype(np.int16)), mask, corner)

    def blend(self):
        """https://docs.opencv.org/5.x/d6/d4a/classcv_1_1detail_1_1Blender.html#aa0a91ce0d6046d3a63e0123cbb1b5c00"""  # noqa
        result = None
        result_mask = None
