...
# Root landing page generated by conf_helpers.build.
master_doc = "index"
...
include_patterns = ["index.markdown", "tutorials/tutorials.markdown", "faq.markdown",
...
if CONTRIB_MODULES and (SPHINX_INPUT_ROOT / "tutorials_contrib").is_dir():
    include_patterns.append("tutorials_contrib/tutorials_contrib.markdown")
