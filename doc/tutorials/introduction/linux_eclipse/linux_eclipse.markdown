...
-#  We are only missing one final step: To tell OpenCV where the OpenCV headers and libraries are.
    ...
    -   In **C/C++ Build**, click on **Settings**. At the right, choose the **Tool Settings** Tab.
        ...
        -#  Now go to **GCC C++ Linker**,there you have to fill two spaces:
            ...
            opencv_core opencv_imgproc opencv_imgcodecs opencv_highgui opencv_ml opencv_videoio opencv_video opencv_features
            ...
            @code{.bash}
            -L/usr/local/lib -lopencv_core -lopencv_imgproc -lopencv_highgui -lopencv_ml -lopencv_video -lopencv_features -lopencv_calib3d -lopencv_objdetect -lopencv_videoio -lopencv_imgcodecs -lopencv_flann
            @endcode
