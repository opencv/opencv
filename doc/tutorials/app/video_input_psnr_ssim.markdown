...
](https://github.com/opencv/opencv/tree/5.x/samples/data/Megamind.avi) and [a compressed
version of it ](https://github.com/opencv/opencv/tree/5.x/samples/data/Megamind_bugy.avi).
