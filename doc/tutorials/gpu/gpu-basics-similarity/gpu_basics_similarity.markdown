...
source library or download it from [here](https://github.com/opencv/opencv/tree/5.x/samples/cpp/tutorial_code/gpu/gpu-basics-similarity/gpu-basics-similarity.cpp).
