...
Python example
--
There are two options to run the sample code in Python (`opencv/apps/multview-calibration/multiview_calibration.py`) either with raw images or provided points.
...
To run the calibration procedure in Python follow the following steps (see sample code in `apps/multview-calibration/multiview_calibration.py`):

-# **Prepare data**:

  @snippet apps/multview-calibration/multiview_calibration.py calib_init
...
-# **Detect pattern points on images**:
  ...
  @snippet apps/multview-calibration/multiview_calibration.py detect_pattern

-# **Build detection mask matrix**:

  @snippet apps/multview-calibration/multiview_calibration.py detection_matrix

-# **Finally, the calibration function is run as follows**:

  @snippet apps/multview-calibration/multiview_calibration.py multiview_calib
...
-# **Intrinsics calibration**
  ...
  -# Camera intrinsics can be better estimated when points are more scattered in the image. The following code can be used to plot out the heat map of the observed point
    ...
    @snippet apps/multview-calibration/multiview_calibration.py plot_detection
  ...
  -# If ground truth camera intrinsics are available, a visualization of the estimated error on intrinsics is provided.
    ...
    @snippet apps/multview-calibration/multiview_calibration.py vis_intrinsics_error
...
-# **Multiview calibration**
  ...
  -# Visulization method for showing the reprojection error with arrows (from a given point to the back-projected one) is provided (see `plotProjection` in apps/multview-calibration/multiview_calibration.py). The color of the arrows highlights the error values. Additionally, the title reports mean error on this frame and its accuracy among other frames used in calibration.
