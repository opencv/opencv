...
Once we obtain the *Mat* object we can do all our processing on that particular Mat instance. For example if we want to convert image to gray, we can do it via below code.
