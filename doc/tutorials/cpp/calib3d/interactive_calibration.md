...
According to classical calibration technique user must collect all data first and then run [cv::calibrateCamera](https://docs.opencv.org/5.x/d4/d93/group__calib.html#gad7db27d1ba05e354db40ce423d18b708) function
...
selection or collecting data and starting of [cv::calibrateCamera](https://docs.opencv.org/5.x/d4/d93/group__calib.html#gad7db27d1ba05e354db40ce423d18b708) repeats.
...
-  *calibration_step*: interval in frames between launches of [cv::calibrateCamera](https://docs.opencv.org/5.x/d4/d93/group__calib.html#gad7db27d1ba05e354db40ce423d18b708)
...
-  *solver_eps*: precision of Levenberg-Marquardt solver in [cv::calibrateCamera](https://docs.opencv.org/5.x/d4/d93/group__calib.html#gad7db27d1ba05e354db40ce423d18b708)
...
data filter. It tries to remove "bad" frames from dataset. Filter removes the frame
 on which $loss\_function$ takes maximum.
...
**RMS** is an average re-projection error calculated for frame *i*, **reducedGridQuality**
 is scene coverage quality evaluation without frame *i*. $\alpha$ is equals to
