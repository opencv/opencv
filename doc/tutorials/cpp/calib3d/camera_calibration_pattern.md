...
1. For camera intrinsics (internal parameters) calibration. See [Camera calibration With OpenCV](camera_calibration.md).
2. For stereo or multi-camera system extrinsics (external parameters: rotation and translation
   of each camera) calibration. See [cv::stereoCalibrate](https://docs.opencv.org/5.x/d4/d93/group__calib.html#ga91018d80e2a93ade37539f01e6f07de5) for details.
3. Camera pose registration relative to well known point in 3d world. See [Multi-view Camera Calibration Tutorial](multiview_calibration.md)

## Pattern Types

**Chessboard**. Classic calibration pattern of black and white squares. The all calibration algorithms
use internal chessboard corners as features. See [cv::findChessboardCorners](https://docs.opencv.org/5.x/d4/d93/group__calib.html#ga93efa9b0aa890de240ca32b11253dd4a) and [cv::cornerSubPix](https://docs.opencv.org/5.x/dd/d1a/group__imgproc__feature.html#ga354e0d7c86d0d9da75de9b9701a9a87e) to
...
circles on a white background or vice verse. See [cv::findCirclesGrid](https://docs.opencv.org/5.x/d4/d93/group__calib.html#ga7f02cd21c8352142890190227628fa80) function to detect the board
...
of size  N-1 x M-1. OpenCV provides [cv::aruco::CharucoDetector](https://docs.opencv.org/5.x/d9/df5/classcv_1_1aruco_1_1CharucoDetector.html) class for the board detection.
