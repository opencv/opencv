...
(*[cv::Mat](https://docs.opencv.org/5.x/d3/d63/classcv_1_1Mat.html)* or *IplImage_* objects, for example) while debugging an application. This can be helpful
...
1. An OpenCV installation on your Windows machine (Tutorial: [Installation in Windows](windows_install.md)).
1. Ability to create and build OpenCV projects in Visual Studio (Tutorial: [How to build applications with OpenCV inside the "Microsoft Visual Studio"](windows_visual_studio_opencv.md)).
...
Image Watch works with any existing project that uses OpenCV image objects (for example, *[cv::Mat](https://docs.opencv.org/5.x/d3/d63/classcv_1_1Mat.html)*).
...
it has not been initialized yet (using *[cv::Mat::create](https://docs.opencv.org/5.x/d3/d63/classcv_1_1Mat.html#a8634d5c6072007534391b295e80b13ee)()*, for example). If you make one more step
over the *[cv::Canny](https://docs.opencv.org/5.x/dd/d1a/group__imgproc__feature.html#ga2a671611e104c093843d7b7fc46d24af)()* call, you will see a thumbnail of the edge image appear in the image list.

Now assume you want to do a visual sanity check of the *[cv::Canny](https://docs.opencv.org/5.x/dd/d1a/group__imgproc__feature.html#ga2a671611e104c093843d7b7fc46d24af)()* implementation. Bring the
...
1. clamping, thresholding, or diff'ing images directly inside the Watch window
1. comparing an in-memory image against a reference image from a file
