...
For detailed instruction on installing OpenCV with desktop Java support refer to the [corresponding tutorial](java_dev_intro.md).
...
1. Place it on your $PATH (cf. \~/bin is a good choice if it is on your path.)
1. Set the script to be executable. (i.e. chmod 755 \~/bin/lein).
...
Let's now try to port to Clojure the [OpenCV Java tutorial sample](java_dev_intro.md).
...
[CV_8UC3](https://docs.opencv.org/5.x/d1/d1b/group__core__hal__interface.html#ga88c4cd9de76f678f33928ef1e3f96047) elements type. Let's create a new Mat instance of the same dimensions and elements type.
